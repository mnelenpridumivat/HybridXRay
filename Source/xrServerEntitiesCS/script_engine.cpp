...
static void initialize_lua_studio(lua_State* state, cs::lua_debugger::world*& world, lua_studio_engine*& engine)
{
    ...
    s_create_world = (create_world_function_type)GetProcAddress(s_script_debugger_handle, "_cs_script_debugger_create_world@4");
    R_ASSERT2(s_create_world, "can't find function \"create_world\"");

    s_destroy_world = (destroy_world_function_type)GetProcAddress(s_script_debugger_handle, "_cs_script_debugger_destroy_world@4");
