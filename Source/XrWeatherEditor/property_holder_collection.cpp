    ...
    refresh_grid_on_change_enum const&  refresh_grid)
{
    m_container->add_property(
        gcnew PropertySpec(
            to_string(identifier), property_collection::typeid, to_string(category), to_string(description)),
        gcnew property_collection(collection));
    ...
    refresh_grid_on_change_enum const&  refresh_grid)
{
    m_container->add_property(
        gcnew PropertySpec(
            to_string(identifier), property_collection::typeid, to_string(category), to_string(description)),
        gcnew property_collection_getter(collection_getter));
