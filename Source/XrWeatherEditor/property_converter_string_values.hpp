...
public
ref class property_converter_string_values: public System::ComponentModel::StringConverter
{
private:
...
public
ref class property_converter_string_values_no_enter: public property_converter_string_values
{
public:
    virtual bool CanConvertFrom(ITypeDescriptorContext ^ context, Type ^ source_type) override
    {
