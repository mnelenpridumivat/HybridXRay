...
property_color_base::property_color_base(XrWeatherEditor::color const % color, array<System::Attribute ^> ^ attributes)
{
    ...
    spec = gcnew PropertySpec(
        "red", float ::typeid, "components", "red component", color.r, (String ^) nullptr,
        property_converter_float::typeid);
    spec->Attributes =
        gcnew array<System::Attribute ^>{gcnew System::ComponentModel::NotifyParentPropertyAttribute(true)};
    ...
    spec = gcnew PropertySpec(
        "green", float ::typeid, "components", "green component", color.g, (String ^) nullptr,
        property_converter_float::typeid);
    ...
    spec = gcnew PropertySpec(
        "blue", float ::typeid, "components", "blue component", color.b, (String ^) nullptr,
        property_converter_float::typeid);
