    ...
    refresh_grid_on_change_enum const&  refresh_grid)
{
    m_container->add_property(
        gcnew PropertySpec(
            to_string(identifier), String::typeid, to_string(category), to_string(description),
    ...
    refresh_grid_on_change_enum const&  refresh_grid)
{
    m_container->add_property(
        ...
        gcnew property_file_name_value(
            getter, setter, to_string(default_extension), to_string(file_mask), to_string(default_folder),
            to_string(caption), extension_action == remove_extension));
    ...
    refresh_grid_on_change_enum const&  refresh_grid)
{
    m_container->add_property(
        ...
        gcnew property_file_name_value_shared_str(
            m_engine, value, to_string(default_extension), to_string(file_mask), to_string(default_folder),
            to_string(caption), extension_action == remove_extension));
    ...
    refresh_grid_on_change_enum const&  refresh_grid)
{
    ...
    if (value_editor == value_editor_tree_view)
    {
        if (can_enter_text == property_holder::can_enter_text)
            ...
            spec = gcnew PropertySpec(
                to_string(identifier), String::typeid, to_string(category), to_string(description),
                to_string(default_value), property_editor_tree_values::typeid, property_converter_tree_values::typeid);
    }
    else
    {
