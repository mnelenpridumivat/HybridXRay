...
#define PROPERTY_CONVERTER_FLOAT_ENUM_HPP_INCLUDED

public
ref class property_converter_float_enum: public System::ComponentModel::StringConverter
{
private:
...
#endif   // ifndef PROPERTY_CONVERTER_FLOAT_ENUM_HPP_INCLUDED
