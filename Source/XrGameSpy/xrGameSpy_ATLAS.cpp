...
XRGAMESPY_API gsi_u32 xrGS_wsLoginProfile(
...
XRGAMESPY_API SCResult xrGS_scCreateSession(
...
XRGAMESPY_API SCResult
    xrGS_scSetSessionId(const SCInterfacePtr theInterface, const gsi_u8 theSessionId[SC_SESSION_GUID_SIZE])
{
    return scSetSessionId(theInterface, theSessionId);
}

XRGAMESPY_API SCResult xrGS_scSetReportIntention(
    ...
    void*                        theUserData)
{
    return scSetReportIntention(
        theInterface, theConnectionId, isAuthoritative, theCertificate, thePrivateData, theCallback, theTimeoutMs,
        theUserData);
}
...
XRGAMESPY_API SCResult xrGS_scCreateReport(
    const SCInterfacePtr theInterface,
...
XRGAMESPY_API SCResult xrGS_scReportSetPlayerData(
...
XRGAMESPY_API SCResult
    xrGS_scReportAddStringValue(SCReportPtr theReportData, gsi_u16 theKeyId, const gsi_char* theValue)
{
...
XRGAMESPY_API SCResult xrGS_scSubmitReport(
    const SCInterfacePtr      theInterface,
    ...
    void*                     theUserData)
{
    return scSubmitReport(
        theInterface, theReport, isAuthoritative, theCertificate, thePrivateData, theCallback, theTimeoutMs,
        theUserData);
}
