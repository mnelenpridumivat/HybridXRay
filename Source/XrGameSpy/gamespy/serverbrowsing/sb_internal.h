...
#define SB_ICMP_SUPPORT
    ...
    typedef void (
        *SBListCallBackFn)(SBServerListPtr serverlist, SBListCallbackReason reason, SBServer server, void* instance);
    ...
    typedef void (*SBMaploopCallbackFn)(
        ...
        char*           mapList[],
        void*           instance);
    typedef void (*SBPlayerSearchCallbackFn)(
        SBServerListPtr serverlist,
        char*           nick,
        goa_uint32      serverIP,
...
#define SB_ICMP_ECHO_REPLY 0
    ...
    SBError SBServerListConnectAndQuery(
        ...
        int           maxServers);
    SBError
        SBServerListGetLANList(SBServerList* slist, unsigned short startport, unsigned short endport, int queryversion);
