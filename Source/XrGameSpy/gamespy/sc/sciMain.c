    ...
    void*                     theUserData)
{
    ...
    return sciWsCreateSession(
        &anInterface->mWebServices, anInterface->mGameId, theCertificate, thePrivateData, theCallback, theTimeoutMs,
        theUserData);
}
    ...
    void*                     theUserData)
{
    ...
    return sciWsCreateMatchlessSession(
        &anInterface->mWebServices, anInterface->mGameId, theCertificate, thePrivateData, theCallback, theTimeoutMs,
        theUserData);
}
    ...
    void*                        theUserData)
{
    ...
    // Call web service
    return sciWsSetReportIntention(
        &anInterface->mWebServices, anInterface->mGameId, (char*)anInterface->mSessionId,
    ...
    SCPeerCipher*              theCipherOut)
{
            ...
            &theCertPrivateData->mPeerPrivateKey, (unsigned char*)theMsg, theCipherOut->mKey, &theCipherOut->mKeyLen))
    {
        ...
        gsDebugBinary(
            GSIDebugCat_App, GSIDebugType_Misc, GSIDebugLevel_Notice, (char*)theCipherOut->mKey,
