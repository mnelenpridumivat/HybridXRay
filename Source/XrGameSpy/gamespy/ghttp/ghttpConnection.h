...
#define CHUNK_HEADER_SIZE 10
    ...
    typedef struct GHIConnection
    {
        ...
        GHTTPBool persistConnection;   // If TRUE, Connection: close will not be sent in the headers and the connection
                                       // will be left open
        ...
        gsi_time
            maxRecvTime;   // Max time spent receiving per call to "Think" - Prevents blocking on ultrafast connections
