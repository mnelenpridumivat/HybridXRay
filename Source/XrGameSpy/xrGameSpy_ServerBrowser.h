...
extern "C"
{
    ...
    //*queryFromGamename, const gsi_char *queryFromKey, int queryFromVersion, int maxConcUpdates, int queryVersion,
    //SBBool bLAN_Only, ServerBrowserCallback callback, void *instance));
    EXPORT_FN_DECL(
        ServerBrowser,
        ServerBrowserNewA,
        (SBBool bLAN_Only, ServerBrowserCallback callback, void* instance));
    ...
    EXPORT_FN_DECL(
        ...
        (SBServer server, int playernum, const gsi_char* key, int idefault));
    EXPORT_FN_DECL(
        double,
    ...
    EXPORT_FN_DECL(
        ...
        (SBServer server, int teamnum, const gsi_char* key, double fdefault));
