...
static unsigned char Fields_Of_Interest[] = {HOSTNAME_KEY,        HOSTPORT_KEY,  NUMPLAYERS_KEY,   MAXPLAYERS_KEY,
                                             MAPNAME_KEY,         GAMETYPE_KEY,  GAMEVER_KEY,      PASSWORD_KEY,
                                             G_USER_PASSWORD_KEY, DEDICATED_KEY, GAMETYPE_NAME_KEY};
...
XRGAMESPY_API ServerBrowser xrGS_ServerBrowserNewA(SBBool bLAN_Only, ServerBrowserCallback callback, void* instance)
{
    ...
    return ServerBrowserNewA(
        GAMESPY_GAMENAME, GAMESPY_GAMENAME, SecretKey, 0, GAMESPY_BROWSER_MAX_UPDATES, xrGS_GetQueryVersion(),
        bLAN_Only, callback, instance);
}
...
XRGAMESPY_API SBError
    xrGS_ServerBrowserUpdateA(ServerBrowser sb, SBBool async, SBBool disconnectOnComplete, const gsi_char* serverFilter)
{
...
XRGAMESPY_API void
    xrGS_ServerBrowserSortA(ServerBrowser sb, SBBool ascending, const char* sortkey, SBCompareMode comparemode)
{
...
XRGAMESPY_API const gsi_char*
    xrGS_SBServerGetStringValueA(SBServer server, const gsi_char* keyname, const gsi_char* def)
{
...
XRGAMESPY_API SBError
    xrGS_ServerBrowserAuxUpdateServer(ServerBrowser sb, SBServer server, SBBool async, SBBool fullUpdate)
{
...
XRGAMESPY_API const gsi_char*
    xrGS_SBServerGetPlayerStringValueA(SBServer server, int playernum, const gsi_char* key, const gsi_char* sdefault)
{
...
XRGAMESPY_API double
    xrGS_SBServerGetPlayerFloatValueA(SBServer server, int playernum, const gsi_char* key, double fdefault)
{
    return SBServerGetPlayerFloatValueA(server, playernum, key, fdefault);
}

XRGAMESPY_API const gsi_char*
    xrGS_SBServerGetTeamStringValueA(SBServer server, int teamnum, const gsi_char* key, const gsi_char* sdefault)
{
...
XRGAMESPY_API SBBool
    xrGS_SBServerGetConnectionInfo(ServerBrowser sb, SBServer server, gsi_u16 PortToConnectTo, char* ipstring)
{
