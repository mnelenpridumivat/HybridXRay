...
namespace gamespy_gp
{
    ...
    struct profile
    {
        ...
        profile(GPProfile const& pid, char const* unique_nick, char const* login_ticket, bool const online): m_profile_id(pid), m_unique_nick(unique_nick), m_login_ticket(login_ticket), m_online(online) {}

        char const* unique_nick() const
        {
            return m_unique_nick.c_str();
        };
        bool const online() const
        {
            return m_online;
        };
        GPProfile const profile_id() const
        {
            return m_profile_id;
        };
    ...
    public:
        ...
        profile const* get_current_profile() const
        {
    ...
    private:
        ...
        queued_async_method<login_manager, login_params_t, login_operation_cb, &login_manager::login_raw, &login_manager::release_login>                         m_login_qam;
        ...
        queued_async_method<login_manager, set_unick_params_t, login_operation_cb, &login_manager::set_unique_nick_raw, &login_manager::release_set_unique_nick> m_unique_nick_qam;
