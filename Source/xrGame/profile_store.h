...
namespace gamespy_profile
{
    ...
    public:
        ...
        awards_store*            get_awards_store()
        {
            return m_awards_store;
        };
        best_scores_store* get_best_scores_store()
        {
            return m_best_scores_store;
        };
    ...
    private:
        ...
        queued_async_method<profile_store, load_prof_params_t, store_operation_cb, &profile_store::load_current_profile_raw, &profile_store::release_current_profile> m_load_current_profile_qam;
        ...
        void                                                                                                                                                          merge_fields(best_scores_store::best_fields_names_t const& best_results, awards_store::award_fields_names_t const& awards_fields);
        ...
        static void __cdecl get_my_fields_cb(SAKE sake, SAKERequest request, SAKERequestResult result, void* inputData, void* outputData, void* userData);
