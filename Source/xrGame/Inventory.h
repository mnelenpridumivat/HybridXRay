...
public:
    ...
    IC u16 FirstSlot() const
    {
        return KNIFE_SLOT;
    }
    IC u16 LastSlot() const
    {
        return LAST_SLOT;
    }   // not "end"
    ...
    IC u16       GetActiveSlot() const
    {
        return m_iActiveSlot;
    }

    void SetPrevActiveSlot(u16 ActiveSlot)
    {
        m_iPrevActiveSlot = ActiveSlot;
    }
    u16 GetPrevActiveSlot() const
    {
        return m_iPrevActiveSlot;
    }
    IC u16 GetNextActiveSlot() const
    {
