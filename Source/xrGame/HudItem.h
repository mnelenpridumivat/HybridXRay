...
public:
    ...
    BOOL    GetHUDmode();
    IC BOOL IsPending() const
    {
        return !!m_huditem_flags.test(fl_pending);
    }
    ...
    IC BOOL RenderHud()
    {
        return m_huditem_flags.test(fl_renderhud);
    }
...
public:
    const shared_str& HudSection() const
    {
        return hud_sect;
    }
