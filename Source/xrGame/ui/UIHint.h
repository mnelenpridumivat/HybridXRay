...
public:
    ...
    IC void set_visible(bool status = true)
    {
        m_visible = status;
    }
    IC bool is_visible() const
    {
        return m_visible;
    }

    IC void set_rect(Frect const& rect)
    {
        m_rect.set(rect);
    }
    IC Frect const& get_rect() const
    {
        return m_rect;
    }
...
public:
    ...
    IC UIHint* get_hint_wnd() const
    {
        return m_hint_wnd;
    }

    IC void set_hint_delay(u32 delay)
    {
        m_hint_delay = delay;
    }
    IC u32 get_hint_delay() const
    {
        return m_hint_delay;
    }
