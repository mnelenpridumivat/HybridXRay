...
namespace gamespy_gp
{
    ...
    public:
        ...
        void                           create_profile(char const* nick, char const* unique_nick, char const* email, char const* password, account_operation_cb opcb);
    ...
    private:
        ...
        queued_async_method<account_manager, get_account_params_t, account_profiles_cb, &account_manager::get_account_profiles_raw, &account_manager::release_account_profiles>           m_get_account_profiles_qam;
        ...
        queued_async_method<account_manager, search_for_email_params_t, found_email_cb, &account_manager::search_for_email_raw, &account_manager::release_found_email>                    m_search_for_email_qam;
        ...
        queued_async_method<account_manager, suggest_uniqie_nicks_params_t, suggest_nicks_cb, &account_manager::suggest_unique_nicks_raw, &account_manager::release_suggest_uniqie_nicks> m_suggest_uniqie_nicks_qam;
