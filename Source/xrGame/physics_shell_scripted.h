...
public:
    ...
    u16                        get_ElementsNumber()
    {
        return physics_impl().get_ElementsNumber();
    }
    ...
    u16                      get_JointsNumber()
    {
        return physics_impl().get_JointsNumber();
    }
    void BlockBreaking()
    {
        physics_impl().BlockBreaking();
    }
    void UnblockBreaking()
    {
        physics_impl().UnblockBreaking();
    }
    bool IsBreakingBlocked()
    {
        return physics_impl().IsBreakingBlocked();
    }
    bool isBreakable()
    {
        return physics_impl().isBreakable();
    }
