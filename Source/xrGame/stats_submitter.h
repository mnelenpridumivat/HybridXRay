...
namespace gamespy_profile
{
    ...
    public:
        ...
        void               reward_with_award(enum_awards_t award_id, u32 const count, gamespy_gp::profile const* profile, store_operation_cb opcb);
        ...
        void               submit_all(all_awards_t const* awards, all_best_scores_t const* scores, gamespy_gp::profile const* profile, store_operation_cb opcb);
    ...
    private:
        ...
        static void __cdecl created_session_cb(const SCInterfacePtr theInterface, GHTTPResult theHttpResult, SCResult theResult, void* theUserData);
        static void __cdecl set_intension_cb(const SCInterfacePtr theInterface, GHTTPResult theHttpResult, SCResult theResult, void* theUserData);
        static void __cdecl submitted_cb(const SCInterfacePtr theInterface, GHTTPResult theHttpResult, SCResult theResult, void* theUserData);
    };
