...
// STREAM_DEMOSTRING_MAX_SIZE); void stream_write_demostring(IWriter* writer, shared_str const & string_to_write, u32
// max_size = STREAM_DEMOSTRING_MAX_SIZE);
...
public:
    ...
    s16 const get_frags() const
    {
        return m_frags;
    };
    s16 const get_deaths() const
    {
        return m_deaths;
    };
    u16 const get_artefacts() const
    {
        return m_artefacts;
    };
    s16 const get_spots() const
    {
        return m_spots;
    };
    u8 const get_team() const
    {
        return m_team;
    };
    u8 const get_rank() const
    {
        return m_rank;
    };
...
public:
    ...
    LPCSTR get_map_version() const
    {
        return m_map_version.c_str();
    };
    LPCSTR get_game_type() const
    {
        return m_game_type.c_str();
    };
    LPCSTR get_game_score() const
    {
        return m_game_score.c_str();
    };
    LPCSTR get_author_name() const
    {
        return m_author_name.c_str();
    };
    u32 const get_players_count() const
    {
