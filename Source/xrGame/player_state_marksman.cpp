...
namespace award_system
{
    ...
    player_state_marksman::player_state_marksman(game_state_accumulator* owner): inherited(owner)
    {
        m_spawn_time = 0;
    }
    ...
    void player_state_marksman::OnPlayerKilled(u16 killer_id, u16 target_id, u16 weapon_id, std::pair<KILL_TYPE, SPECIAL_KILL_TYPE> kill_type)
    {
