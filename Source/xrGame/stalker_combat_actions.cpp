...
CStalkerCombatActionSmartCover::CStalkerCombatActionSmartCover(CAI_Stalker* object, LPCSTR action_name): inherited(object, action_name), m_check_can_kill_enemy(false) {}
