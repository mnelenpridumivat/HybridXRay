...
{
    module(L)[class_<CStalkerPlanner>("stalker_ids")
                  .enum_("properties")[luabind::value("property_alive", StalkerDecisionSpace::eWorldPropertyAlive), luabind::value("property_dead", StalkerDecisionSpace::eWorldPropertyDead), luabind::value("property_already_dead", StalkerDecisionSpace::eWorldPropertyAlreadyDead), luabind::value("property_alife", StalkerDecisionSpace::eWorldPropertyALife), luabind::value("property_puzzle_solved", StalkerDecisionSpace::eWorldPropertyPuzzleSolved),
                      luabind::value("property_smart_terrain_task", StalkerDecisionSpace::eWorldPropertySmartTerrainTask), luabind::value("property_items", StalkerDecisionSpace::eWorldPropertyItems), luabind::value("property_enemy", StalkerDecisionSpace::eWorldPropertyEnemy), luabind::value("property_danger", StalkerDecisionSpace::eWorldPropertyDanger), luabind::value("property_item_to_kill", StalkerDecisionSpace::eWorldPropertyItemToKill),
                      luabind::value("property_found_item_to_kill", StalkerDecisionSpace::eWorldPropertyFoundItemToKill), luabind::value("property_item_can_kill", StalkerDecisionSpace::eWorldPropertyItemCanKill), luabind::value("property_found_ammo", StalkerDecisionSpace::eWorldPropertyFoundAmmo), luabind::value("property_ready_to_kill", StalkerDecisionSpace::eWorldPropertyReadyToKill), luabind::value("property_ready_to_detour", StalkerDecisionSpace::eWorldPropertyReadyToDetour),
                      luabind::value("property_see_enemy", StalkerDecisionSpace::eWorldPropertySeeEnemy), luabind::value("property_panic", StalkerDecisionSpace::eWorldPropertyPanic), luabind::value("property_in_cover", StalkerDecisionSpace::eWorldPropertyInCover), luabind::value("property_looked_out", StalkerDecisionSpace::eWorldPropertyLookedOut), luabind::value("property_position_holded", StalkerDecisionSpace::eWorldPropertyPositionHolded),
                      luabind::value("property_enemy_detoured", StalkerDecisionSpace::eWorldPropertyEnemyDetoured), luabind::value("property_use_suddenness", StalkerDecisionSpace::eWorldPropertyUseSuddenness), luabind::value("property_use_crouch_to_look_out", StalkerDecisionSpace::eWorldPropertyUseCrouchToLookOut), luabind::value("property_critically_wounded", StalkerDecisionSpace::eWorldPropertyCriticallyWounded),
                      luabind::value("property_enemy_critically_wounded", StalkerDecisionSpace::eWorldPropertyEnemyCriticallyWounded),

                      luabind::value("property_danger_unknown", StalkerDecisionSpace::eWorldPropertyDangerUnknown), luabind::value("property_danger_in_direction", StalkerDecisionSpace::eWorldPropertyDangerInDirection), luabind::value("property_danger_grenade", StalkerDecisionSpace::eWorldPropertyDangerGrenade), luabind::value("property_danger_by_sound", StalkerDecisionSpace::eWorldPropertyDangerBySound),

                      luabind::value("property_cover_actual", StalkerDecisionSpace::eWorldPropertyCoverActual), luabind::value("property_cover_reached", StalkerDecisionSpace::eWorldPropertyCoverReached), luabind::value("property_looked_around", StalkerDecisionSpace::eWorldPropertyLookedAround), luabind::value("property_grenade_exploded", StalkerDecisionSpace::eWorldPropertyGrenadeExploded),

                      luabind::value("property_anomaly", StalkerDecisionSpace::eWorldPropertyAnomaly), luabind::value("property_inside_anomaly", StalkerDecisionSpace::eWorldPropertyInsideAnomaly), luabind::value("property_pure_enemy", StalkerDecisionSpace::eWorldPropertyPureEnemy), luabind::value("property_script", StalkerDecisionSpace::eWorldPropertyScript)]

                  .enum_("action")[luabind::value("action_dead", StalkerDecisionSpace::eWorldOperatorDead), luabind::value("action_dying", StalkerDecisionSpace::eWorldOperatorDying), luabind::value("action_gather_items", StalkerDecisionSpace::eWorldOperatorGatherItems), luabind::value("action_no_alife", StalkerDecisionSpace::eWorldOperatorALifeEmulation), luabind::value("action_smart_terrain_task", StalkerDecisionSpace::eWorldOperatorSmartTerrainTask),
                      ...
                      luabind::value("action_danger_in_direction_detour", StalkerDecisionSpace::eWorldOperatorDangerInDirectionDetourEnemy), luabind::value("action_danger_in_direction_search", StalkerDecisionSpace::eWorldOperatorDangerInDirectionSearchEnemy),

                      luabind::value("action_danger_grenade_take_cover", StalkerDecisionSpace::eWorldOperatorDangerGrenadeTakeCover), luabind::value("action_danger_grenade_wait_for_explosion", StalkerDecisionSpace::eWorldOperatorDangerGrenadeWaitForExplosion), luabind::value("action_danger_grenade_take_cover_after_explosion", StalkerDecisionSpace::eWorldOperatorDangerGrenadeTakeCoverAfterExplosion),
                      luabind::value("action_danger_grenade_look_around", StalkerDecisionSpace::eWorldOperatorDangerGrenadeLookAround), luabind::value("action_danger_grenade_search", StalkerDecisionSpace::eWorldOperatorDangerGrenadeSearch),

                      luabind::value("action_death_planner", StalkerDecisionSpace::eWorldOperatorDeathPlanner), luabind::value("action_alife_planner", StalkerDecisionSpace::eWorldOperatorALifePlanner), luabind::value("action_combat_planner", StalkerDecisionSpace::eWorldOperatorCombatPlanner), luabind::value("action_anomaly_planner", StalkerDecisionSpace::eWorldOperatorAnomalyPlanner), luabind::value("action_danger_planner", StalkerDecisionSpace::eWorldOperatorDangerPlanner),
                      luabind::value("action_post_combat_wait", StalkerDecisionSpace::eWorldOperatorPostCombatWait), luabind::value("action_script", StalkerDecisionSpace::eWorldOperatorScript)]

                  .enum_("sounds")[luabind::value("sound_die", StalkerSpace::eStalkerSoundDie), luabind::value("sound_die_in_anomaly", StalkerSpace::eStalkerSoundDieInAnomaly), luabind::value("sound_injuring", StalkerSpace::eStalkerSoundInjuring), luabind::value("sound_humming", StalkerSpace::eStalkerSoundHumming), luabind::value("sound_alarm", StalkerSpace::eStalkerSoundAlarm), luabind::value("sound_attack_no_allies", StalkerSpace::eStalkerSoundAttackNoAllies),
                      ...
                      luabind::value("sound_search1_with_allies", StalkerSpace::eStalkerSoundSearch1WithAllies), luabind::value("sound_enemy_lost_no_allies", StalkerSpace::eStalkerSoundEnemyLostNoAllies), luabind::value("sound_enemy_lost_with_allies", StalkerSpace::eStalkerSoundEnemyLostWithAllies), luabind::value("sound_injuring_by_friend", StalkerSpace::eStalkerSoundInjuringByFriend), luabind::value("sound_panic_human", StalkerSpace::eStalkerSoundPanicHuman),
                      luabind::value("sound_panic_monster", StalkerSpace::eStalkerSoundPanicMonster), luabind::value("sound_tolls", StalkerSpace::eStalkerSoundTolls), luabind::value("sound_wounded", StalkerSpace::eStalkerSoundWounded), luabind::value("sound_grenade_alarm", StalkerSpace::eStalkerSoundGrenadeAlarm), luabind::value("sound_friendly_grenade_alarm", StalkerSpace::eStalkerSoundFriendlyGrenadeAlarm), luabind::value("sound_need_backup", StalkerSpace::eStalkerSoundNeedBackup),
                      ...
                      luabind::value("sound_kill_wounded", StalkerSpace::eStalkerSoundKillWounded), luabind::value("sound_enemy_critically_wounded", StalkerSpace::eStalkerSoundEnemyCriticallyWounded), luabind::value("sound_enemy_killed_or_wounded", StalkerSpace::eStalkerSoundMaskEnemyKilledOrWounded),
