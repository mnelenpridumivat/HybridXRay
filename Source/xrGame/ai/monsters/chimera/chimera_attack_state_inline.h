...
template<class Object> ChimeraAttackState<Object>::ChimeraAttackState(Object* obj): inherited(obj) {}

template<class Object> float ChimeraAttackState<Object>::calculate_min_run_distance() const
{
...
template<class Object> void ChimeraAttackState<Object>::initialize()
{
...
template<class Object> void ChimeraAttackState<Object>::finalize()
{
...
template<class Object> void ChimeraAttackState<Object>::critical_finalize()
{
    finalize();
}

template<class Object> bool ChimeraAttackState<Object>::check_control_start_conditions(ControlCom::EControlType type)
{
...
template<class Object> bool ChimeraAttackState<Object>::check_if_jump_possible(Fvector const& target)
{
    m_allow_jump        = true;
...
template<class Object> bool ChimeraAttackState<Object>::jump(Fvector const& target, bool attack_jump)
{
...
template<class Object> float ChimeraAttackState<Object>::get_attack_radius() const
{
    return object->get_attack_params().attack_radius;
}

template<class Object> bool ChimeraAttackState<Object>::select_target_for_move()
{
...
template<class Object> Fvector ChimeraAttackState<Object>::correct_jump_pos(Fvector const& pos)
{
    //	return										pos;
    Fvector const self_pos      = object->Position();
...
template<class Object> bool ChimeraAttackState<Object>::select_target_for_attack_jump()
{
    CEntityAlive const* const enemy               = object->EnemyMan.get_enemy();
    Fvector const             enemy_pos           = enemy->Position();
...
template<class Object> bool ChimeraAttackState<Object>::select_target_for_jump(enum_action const action)
{
    CEntityAlive const* const enemy     = object->EnemyMan.get_enemy();
    Fvector const             enemy_pos = enemy->Position();
...
template<class Object> void ChimeraAttackState<Object>::set_turn_animation()
{
...
template<class Object> void ChimeraAttackState<Object>::execute()
{
#ifdef DEBUG_STATE
    ...
    bool const can_prepare_jump       = preparing_state && current_time() > m_last_jump_time + object->get_attack_params().prepare_jump_timeout;
    bool const can_attack_jump        = !preparing_state && current_time() > m_last_jump_time + object->get_attack_params().attack_jump_timeout;
