...
template<typename _Object> class CStateGroupSquadMoveToRadiusEx: public CState<_Object>
{
...
template<typename _Object> class CStateGroupSquadMoveToRadius: public CState<_Object>
{
    typedef CState<_Object> inherited;
