...
{
    return xrGS_gpSuggestUniqueNickA(&m_GPConnection, desired_unick.c_str(), GP_NON_BLOCKING, callback, param);
}
...
GPResult CGameSpy_GP::SetUniqueNick(shared_str const& unique_nick, GPCallback callback, void* param)
{
    ...
    return xrGS_gpRegisterUniqueNickA(&m_GPConnection, unique_nick.c_str(), NULL, GP_NON_BLOCKING, callback, param);
}
