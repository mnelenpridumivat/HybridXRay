...
private:
    ...
    GAMESPY_FN_VAR_DECL(
        ...
        (void* qrec, qr2_clientmessagecallback_t cmcallback));
    GAMESPY_FN_VAR_DECL(
        void,
        qr2_register_publicaddress_callback,
        (void* qrec, qr2_publicaddresscallback_t pacallback));
    GAMESPY_FN_VAR_DECL(
        void,
        qr2_register_denyresponsetoip_callback,
        (void* qrec, qr2_denyqr2responsetoipcallback_t dertoipcallback));
