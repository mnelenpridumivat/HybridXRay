...
void __cdecl callback_serverkey(int keyid, qr2_buffer_t outbuf, void* userdata)
{
    ...
    switch (keyid)
    {
        ...
        case MAXPLAYERS_KEY:
            ...
            break;
        case SERVER_UP_TIME_KEY:
            pQR2->BufferAdd(outbuf, time_str);
            break;
        case GAMETYPE_KEY:
        ...
        case G_DAMAGE_BLOCK_INDICATOR_KEY:
            ...
            break;   // if (gmDM)pQR2->BufferAdd_Int(outbuf, gmDM->IsDamageBlockIndEnabled()); else
                     // pQR2->BufferAdd(outbuf, "");	break;
        ...
        case G_WARM_UP_TIME_KEY:
            ...
            break;   // if (gmDM)pQR2->BufferAdd_Int(outbuf, gmDM->GetWarmUpTime());			else
                     // pQR2->BufferAdd(outbuf, "");	break;
