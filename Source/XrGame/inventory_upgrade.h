...
namespace inventory
{
    namespace upgrade
    {
        ...
        namespace detail
        {
            ...
            template<typename return_type> struct functor_base
            {
            ...
            template<typename return_type> struct functor: public functor_base<return_type>
            {
            ...
            template<typename return_type> struct functor2: public functor<return_type>
            {
                LPCSTR         parameter2;
            ...
            template<typename return_type> struct functor3: public functor2<return_type>
            {
                int            parameter3;
            ...
            template<> struct functor<void>: public functor_base<void>
            {
            ...
            template<> struct functor2<void>: public functor<void>
            {
                LPCSTR  parameter2;
                IC void operator()() const
                {
            ...
            template<> struct functor3<void>: public functor2<void>
            {
                int     parameter3;
                IC void operator()() const
                {
