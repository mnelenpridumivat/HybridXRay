...
inline destination_type static_cast_checked(source_type const& source)
{
    ...
    debug::detail::static_cast_checked::helper<source_type const&, destination_type>::check<
        is_polymorphic<pure_source_type>::result>(source);
...
inline destination_type static_cast_checked(source_type& source)
{
    ...
    debug::detail::static_cast_checked::helper<source_type&, destination_type>::check<
        is_polymorphic<pure_source_type>::result>(source);
