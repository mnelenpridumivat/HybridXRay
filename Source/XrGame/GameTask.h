...
public:
    ...
    IC CMapLocation* LinkedMapLocation()
    {
    ...
    void SetType_script(int t)
    {
        m_task_type = (ETaskType)t;
    }
    ...
    void SetDescription_script(LPCSTR _desc)
    {
        m_Description = _desc;
    }
    void SetIconName_script(LPCSTR _tex)
    {
        m_icon_texture_name = _tex;
    }
    LPCSTR GetIconName_script()
    {
        return m_icon_texture_name.c_str();
    }
    void SetMapHint_script(LPCSTR _hint)
    {
        m_map_hint = _hint;
    }

    void SetMapLocation_script(LPCSTR _mls)
    {
        m_map_location = _mls;
    }
    void SetMapObjectID_script(int _id)
    {
        m_map_object_id = (u16)_id;
    }
