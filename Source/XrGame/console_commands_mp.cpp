...
BOOL                 XRNETSERVER_API extern g_net_compressor_gather_stats;
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        xr_strcpy(I, "resyncronize client");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        xr_strcpy(I, "Kick Player by name");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        xr_strcpy(I, "Restarts playing demo.");
    }
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        xr_strcpy(I, "Ban Player by Name");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        xr_strcpy(I, "Ban Player by IP. Format: \"sb_banplayer_ip <ip address>\"");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        xr_strcpy(I, "UnBan Player by IP. Format: \"sv_unbanplayer_ip <ip address>\"");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        xr_strcpy(I, "List Players. Format: \"sv_listplayers [ filter string ]\"");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        xr_strcpy(I, "Changing Game Type. Arguments: <level name> <level version>");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        xr_strcpy(I, "Stops Current Voting");
    };
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        xr_strcpy(I, "saving statistic data");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        xr_strcpy(I, "Set Start Team Money");
    }
};
