...
public:
    ...
    void Set_ShowPlayerNames(bool Show)
    {
        m_bShowPlayersNames = Show;
    };
    bool Get_ShowPlayerNames()
    {
        return m_bShowPlayersNames;
    };
    bool Get_ShowPlayerNamesEnabled()
    {
        return m_bFriendlyNames;
    };
    ...
    s32            GetGreenTeamScore() const
    {
        return greenTeamScore;
    };
    s32 GetBlueTeamScore() const
    {
