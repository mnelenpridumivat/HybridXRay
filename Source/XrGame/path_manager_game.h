...
class CPathManager<IGameGraph, _DataStorage, _Parameters, _dist_type, _index_type, _iteration_type>:
    public CPathManagerGeneric<IGameGraph, _DataStorage, _Parameters, _dist_type, _index_type, _iteration_type>
{
protected:
