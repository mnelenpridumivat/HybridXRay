...
public:
    ...
    BOOSTER_MAP     GetCurBoosterInfluences()
    {
        return m_booster_influences;
    };
    ...
    IC float MaxWalkWeight() const
    {
        return m_MaxWalkWeight;
    }
    ...
    {
        return m_fV_SatietyPower * m_fSatiety;
    };
...
public:
    ...
    {
        return m_fV_SatietyPower;
    }
    IC float const& V_SatietyHealth()
    {
        return m_fV_SatietyHealth;
    }
    IC float const& SatietyCritical()
    {
        return m_fSatietyCritical;
    }
    ...
    float        GetMaxPowerRestoreSpeed()
    {
        return m_max_power_restore_speed;
    };
    float GetMaxWoundProtection()
    {
        return m_max_wound_protection;
    };
    float GetMaxFireWoundProtection()
    {
        return m_max_fire_wound_protection;
    };
