...
public:
    ...
    IC void SetCondition(float val)
    {
        m_fCondition = val;
    }
    ...
    u16 CurrSlot() const
    {
        return m_ItemCurrPlace.slot_id;
    }
    u16 CurrPlace() const
    {
        return m_ItemCurrPlace.type;
    }
...
public:
    IC bool has_any_upgrades()
    {
        return (m_upgrades.size() != 0);
    }
...
public:
    ...
    {
        return !!m_flags.test(FIsHelperItem);
    }
