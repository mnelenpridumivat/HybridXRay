    ...
    bool /**bLight/**/)
{
    ...
    /*
        ...
        if( mat_injurios!=GAMEMTL_NONE_IDX)
        {
            ...
            gcontact_HealthLost+=Device->fTimeDelta*GameMaterialLibrary->GetMaterialByIdx( mat_injurios
       )->fInjuriousSpeed;
        }
    ...
    */
    ...
    if (cdi->HitCallback())
        cdi->HitCallback()->call(
            (m_character->PhysicsRefObject()), fMinCrashSpeed, fMaxCrashSpeed, fContactSpeed, gcontact_HealthLost,
            CollisionDamageInfo());
