...
gsc_dsigned_ltx_reader::gsc_dsigned_ltx_reader(u8 const p_number[crypto::xr_dsa::public_key_length], u8 const q_number[crypto::xr_dsa::private_key_length], u8 const g_number[crypto::xr_dsa::public_key_length], u8 const public_key[crypto::xr_dsa::public_key_length]): xr_dsa_verifyer(p_number, q_number, g_number, public_key), m_ltx(NULL) {}
