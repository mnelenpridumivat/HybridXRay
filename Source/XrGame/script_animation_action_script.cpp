        ...
        L)[class_<CScriptAnimationAction>("anim")
               ...
               .enum_("monster")
                   [value("stand_idle", int(MonsterSpace::eAA_StandIdle)),
                    ...
                    value("lie_idle", int(MonsterSpace::eAA_LieIdle)), value("eat", int(MonsterSpace::eAA_Eat)),
                    value("sleep", int(MonsterSpace::eAA_Sleep)), value("rest", int(MonsterSpace::eAA_Rest)),
