...
public:
    IC void SetWndPosOrigin(const Fvector2& pos)
    {
        m_origin_pos = pos;
    }
    IC void SetWndSizeOrigin(const Fvector2& size)
    {
        m_origin_size = size;
    }
    IC const Fvector2& GetWndPosOrigin() const
    {
        return m_origin_pos;
    }
    IC const Fvector2& GetWndSizeOrigin() const
    {
...
public:
    ...
    ALife::_TIME_ID GetTimerFinish() const
    {
        return m_timer_finish;
    }
