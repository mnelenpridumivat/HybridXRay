...
private:
    IC const Fmatrix& anim_pos() const
    {
        return state.anim_pos;
    }
    IC const ik_goal_matrix& goal() const
    {
        return state.goal;
    }
    IC const ik_goal_matrix& blend_to() const
    {
        return state.blend_to;
    }
    IC const Fvector& pick() const
    {
        return state.pick;
    }
...
public:
    ...
    IC bool foot_step() const
    {
        return state.foot_step;
    }
    IC bool blending() const
    {
        return state.blending;
    }
    IC bool valide() const
    {
        return state_valide(state);
    }
