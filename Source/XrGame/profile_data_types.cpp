...
namespace gamespy_profile
{
    ...
    static u16 award_atlas_stats_map[at_awards_count][ap_award_params_count] = {
        ...
        {STAT_AwardDoubleShotDoubleKill,
         STAT_AwardDoubleShotDoubleKillLastRewardDate},                           // mp_award_double_shot_double_kill
    ...
    static char const* best_score_names[bst_score_types_count] = {
        "mp_bst_kills_in_row",          "mp_bst_kinife_kills_in_row", "mp_bst_backstabs_in_row",
        "mp_bst_head_shots_in_row",     "mp_bst_eye_kills_in_row",    "mp_bst_bleed_kills_in_row",
    ...
    static u16 best_scores_atlas_keys_map[bst_score_types_count] = {
        KEY_BestScore_KillsInRow,          KEY_BestScore_KnifeKillsInRow, KEY_BestScore_BackstabsKillsInRow,
        KEY_BestScore_HeadshotsKillsInRow, KEY_BestScore_EyeKillsInRow,   KEY_BestScore_BleedKillsInRow,
    ...
    static u16 best_scores_atlas_stats_map[bst_score_types_count] = {
        STAT_BestScore_KillsInRow,          STAT_BestScore_KnifeKillsInRow, STAT_BestScore_BackstabsKillsInRow,
        STAT_BestScore_HeadshotsKillsInRow, STAT_BestScore_EyeKillsInRow,   STAT_BestScore_BleedKillsInRow,
