...
public:
    ...
    {
        return m_state != eUploadNotActive;
    };
    void start_upload_info(IReader const* svlogo, IReader const* svrules, ClientID const& toclient, svinfo_upload_complete_cb const& complete_cb);
