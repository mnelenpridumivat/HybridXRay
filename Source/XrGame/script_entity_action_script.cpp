...
void CScriptEntityAction::script_register(lua_State* L)
{
    module(L)
        [class_<CScriptEntityAction>("entity_action")
             ...
             .def(
                 "set_action", (void(CScriptEntityAction::*)(CScriptAnimationAction&))(&CScriptEntityAction::SetAction))
             ...
             .def(
                 "set_action", (void(CScriptEntityAction::*)(CScriptActionCondition&))(&CScriptEntityAction::SetAction))
