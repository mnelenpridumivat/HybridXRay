...
template <typename _item_type> IC CObjectActionBase<_item_type>::CObjectActionBase(
    _item_type*       item,
    CAI_Stalker*      owner,
...
template <typename _item_type> IC CObjectActionMember<_item_type>::CObjectActionMember(
    _item_type*       item,
    CAI_Stalker*      owner,
    CPropertyStorage* storage,
    ...
    m_condition_id(condition_id), m_value(value)
{
}
