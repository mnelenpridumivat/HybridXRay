...
private:
    template <typename _evaluator_type, typename _restrictor_type> IC bool
        inertia(Fvector const& position, float radius, _evaluator_type& evaluator, const _restrictor_type& restrictor)
            const;
...
public:
    ...
    void                                                                                 clear();
    template <typename _evaluator_type, typename _restrictor_type> IC const CCoverPoint* best_cover(
