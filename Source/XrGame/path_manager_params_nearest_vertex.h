...
template<typename _dist_type, typename _index_type, typename _iteration_type> struct SNearestVertex: public SBaseParameters<_dist_type, _index_type, _iteration_type>
{
