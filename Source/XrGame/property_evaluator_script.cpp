...
void CPropertyEvaluator<CScriptGameObject>::script_register(lua_State* L)
{
    module(L)[class_<CScriptPropertyEvaluator, CScriptPropertyEvaluatorWrapper>("property_evaluator")
        ...
        class_<CPropertyEvaluatorConst<CScriptGameObject>, CScriptPropertyEvaluator>("property_evaluator_const").def(constructor<CPropertyEvaluatorConst<CScriptGameObject>::_value_type>())];
}
