        ...
        [class_<CStalkerPlanner>("stalker_ids")
             ...
             .enum_("action")
                 [luabind::value("action_dead", StalkerDecisionSpace::eWorldOperatorDead),
                  ...
                  luabind::value(
                      "action_danger_unknown_look_around", StalkerDecisionSpace::eWorldOperatorDangerUnknownLookAround),
                  luabind::value(
                  ...
                  luabind::value(
                      "action_danger_grenade_look_around", StalkerDecisionSpace::eWorldOperatorDangerGrenadeLookAround),
                  luabind::value(
