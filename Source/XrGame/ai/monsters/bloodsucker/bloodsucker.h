...
public:
    ...
    u32 get_last_critical_hit_tick()
    {
        return m_last_critical_hit_tick;
    }
    void clear_last_critical_hit_tick()
    {
...
public:
    ...
    float get_vampire_distance() const
    {
        return m_vampire_distance;
    }
