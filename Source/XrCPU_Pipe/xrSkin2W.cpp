...
void xrSkin1W_x86(vertRender* D, vertBoned1W* S, u32 vCount, CBoneInstance* Bones)
{
    // Prepare
...
void xrSkin2W_x86(vertRender* D, vertBoned2W* S, u32 vCount, CBoneInstance* Bones)
{
    // Prepare
    int          U_Count = vCount;
    vertBoned2W* V       = S;
...
void xrSkin3W_x86(vertRender* D, vertBoned3W* S, u32 vCount, CBoneInstance* Bones)
{
    // Prepare
    int          U_Count = vCount;
    vertBoned3W* V       = S;
...
void xrSkin4W_x86(vertRender* D, vertBoned4W* S, u32 vCount, CBoneInstance* Bones)
{
    // Prepare
    int          U_Count = vCount;
    vertBoned4W* V       = S;
