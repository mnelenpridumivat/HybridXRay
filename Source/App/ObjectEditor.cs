	...
	public partial class Object_Editor : Form
	{
		...
		private void FlagsHelpButton_Click(object sender, EventArgs e)
		{
			MessageBox.Show("Motion export:\nƒанные флаги вли€ют на компресиию анимаций при экспортировании в OMF.\n1. 8 bit - “„ ‘ормат\n2. 16 bit - «ѕ ‘ормат\n" + (DEVELOPER_MODE ? "3. No compress - экспортирует анимации без сжати€\n\n" : "\n") +
				"Model export:\n" +
				"1. Make progressive meshes - создает прогрессивные меши при экспорте OGF. Ёто динамическа€ детализаци€ модели (lod'ы), чаще используетс€ дл€ мировых объектов, так же вли€ет на основную модель.\n" +
				"2. Make stripify meshes - оптимизаци€ vertex'ов и face'ов у мешей, стоит в SDK по дефолту и чаще используетс€ дл€ моделей с м€гкой прив€зкой.\n" +
                ...
                "4. HQ Geometry+ - при активации компил€тор будет экспортировать модель без оптимизаций вертексов. \n\n" +
                "Object scale - измен€ет размер объекта при экспорте, вли€ет на размер модели и размер анимаций.\nScale center of mass - при активации во врем€ экспорта с измененным размером объекта будут пересчитаны центры массы коллизии под новый размер.", "Help", MessageBoxButtons.OK, MessageBoxIcon.Information);
		}
