    ...
    else
    {
        ...
        switch (C.iElement)
        {
            case SE_R2_NORMAL_HQ:   // deffer
                ...
                C.r_Stencil(
                    TRUE, D3DCMP_ALWAYS, 0xff, 0xff, D3DSTENCILOP_KEEP, D3DSTENCILOP_REPLACE, D3DSTENCILOP_KEEP);
                C.r_StencilRef(0x81);
                if (bUseATOC)
            ...
            case SE_R2_SHADOW:   // smap
                if (bAref)
                {
                    ...
                    C.r_Pass(
                        "shadow_direct_model_aref", "shadow_direct_base_aref", FALSE, TRUE, TRUE, FALSE, D3DBLEND_ZERO,
                ...
                {
                    // if (RImplementation.o.HW_smap)	C.r_Pass	("shadow_direct_model","dumb",
                    // FALSE,TRUE,TRUE,FALSE); else							C.r_Pass
