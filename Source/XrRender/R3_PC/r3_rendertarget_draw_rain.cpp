...
void CRenderTarget::draw_rain(light& RainSetup)
{
    ...
    // Perform lighting
    {
        ...
        */
        ...
        center_pt.mad(Device->vCameraPosition,Device->vCameraDirection,zMin);	Device->mFullTransform.transform
        (center_pt); zMin = center_pt.z	;

        center_pt.mad(Device->vCameraPosition,Device->vCameraDirection,zMax);	Device->mFullTransform.transform
        (center_pt); zMax = center_pt.z	;
        */
