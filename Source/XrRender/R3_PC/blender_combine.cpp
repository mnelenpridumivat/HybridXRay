...
void CBlender_combine::Compile(CBlender_Compile& C)
{
    ...
    switch (C.iElement)
    {
        case 0:   // combine
            C.r_Pass(
                "combine_1", "combine_1_nomsaa", FALSE, FALSE, FALSE, TRUE, D3DBLEND_INVSRCALPHA,
                D3DBLEND_SRCALPHA);                            //. MRT-blend?
            C.r_Stencil(TRUE, D3DCMP_LESSEQUAL, 0x7f, 0x00);   // stencil should be >= 1
            C.r_StencilRef(0x01);
...
void CBlender_combine_msaa::Compile(CBlender_Compile& C)
{
    ...
    switch (C.iElement)
    {
        case 0:   // combine
            C.r_Pass(
                "combine_1", "combine_1_msaa", FALSE, FALSE, FALSE, TRUE, D3DBLEND_INVSRCALPHA,
                D3DBLEND_SRCALPHA);                            //. MRT-blend?
