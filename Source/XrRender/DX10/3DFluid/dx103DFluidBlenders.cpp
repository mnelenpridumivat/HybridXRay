...
void CBlender_fluid_simulate::Compile(CBlender_Compile& C)
{
    ...
    switch (C.iElement)
    {
        ...
        case 1:   // Confinement
            ...
            C.r_Pass(
                "fluid_grid", "fluid_array", "fluid_confinement", false, FALSE, FALSE, TRUE, D3DBLEND_ONE,
                D3DBLEND_ONE);
            break;
        case 2:   // Divergence
...
void CBlender_fluid_obst::Compile(CBlender_Compile& C)
{
    ...
    switch (C.iElement)
    {
        ...
        case 1:   // ObstDynBox
            //	OOBB
            C.r_Pass(
                "fluid_grid_dyn_oobb", "fluid_array_dyn_oobb", "fluid_obst_dynamic_oobb", false, FALSE, FALSE, FALSE);
            break;
    }
...
void CBlender_fluid_emitter::Compile(CBlender_Compile& C)
{
    ...
    switch (C.iElement)
    {
        case 0:   // ET_SimpleGausian
            C.r_Pass(
                "fluid_grid", "fluid_array", "fluid_gaussian", false, FALSE, FALSE, TRUE, D3DBLEND_SRCALPHA,
...
void CBlender_fluid_raydata::Compile(CBlender_Compile& C)
{
    ...
    switch (C.iElement)
    {
        ...
        case 1:   // CompRayData_Front
            C.r_Pass(
                "fluid_raydata_front", "null", "fluid_raydata_front", false, FALSE, FALSE, TRUE, D3DBLEND_ONE,
                D3DBLEND_ONE);
