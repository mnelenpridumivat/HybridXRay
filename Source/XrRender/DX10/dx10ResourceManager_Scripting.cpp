...
#include "../Private/tss.h"
#include "../Private/blenders/blender.h"
#include "../Private/blenders/blender_recorder.h"
...
void CResourceManager::LS_Load()
{
    ...
    module(LSVM)[class_<adopt_dx10options>("_dx10options").def("dx10_msaa_alphatest_atoc", &adopt_dx10options::_dx10_msaa_alphatest_atoc)
