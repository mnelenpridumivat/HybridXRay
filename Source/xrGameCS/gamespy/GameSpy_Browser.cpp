...
#define ADD_INT_INFO(i, s, t, k)                                                              \
    {                                                                                         \
        string256 tmp;                                                                        \
        sprintf_s(tmp, "%d", xrGS_SBServerGetIntValueA(s, m_pQR2->xrGS_RegisteredKey(k), 0)); \
...
#define ADD_INT_INFO_N(i, s, m, t1, t2, k)                                                               \
    {                                                                                                    \
        ...
        {                                                                                                \
            string256 tmp;                                                                               \
            sprintf_s(tmp, "%d" t2, xrGS_SBServerGetIntValueA(s, m_pQR2->xrGS_RegisteredKey(k), 0) * m); \
...
#define ADD_TIME_INFO(i, s, m, t1, t2, t3, k)                                                             \
    {                                                                                                     \
        ...
        {                                                                                                 \
            string256 tmp;                                                                                \
            sprintf_s(tmp, t2, xrGS_SBServerGetFloatValueA(s, m_pQR2->xrGS_RegisteredKey(k), 0) * m, t3); \
            i->m_aInfos.push_back(GameInfo(t1, tmp));                                                     \
        }                                                                                                 \
        else                                                                                              \
        {                                                                                                 \
...
void CGameSpy_Browser::ReadServerInfo(ServerInfo* pServerInfo, void* pServer)
{
    ...
    sprintf_s(pServerInfo->m_ServerUpTime, "%s", xrGS_SBServerGetStringValueA(pServer, m_pQR2->xrGS_RegisteredKey(SERVER_UP_TIME_KEY), "Unknown"));
    ...
    pServerInfo->m_aInfos.push_back(GameInfo(*st.translate("mp_si_voting"), (xrGS_SBServerGetBoolValueA(pServer, m_pQR2->xrGS_RegisteredKey(G_VOTING_ENABLED_KEY), SBFalse) == SBTrue) ? *st.translate("mp_si_enabled") : *st.translate("mp_si_disabled")));
    ...
    if (pServerInfo->m_GameType == eGameIDTeamDeathmatch || pServerInfo->m_GameType == eGameIDArtefactHunt || pServerInfo->m_GameType == eGameIDCaptureTheArtefact)
    {
