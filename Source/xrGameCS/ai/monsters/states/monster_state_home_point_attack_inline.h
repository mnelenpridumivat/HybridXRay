...
CStateMonsterAttackMoveToHomePointAbstract::CStateMonsterAttackMoveToHomePoint(_Object* obj): inherited(obj), m_ignore_enemies_while_hide(0)
{
...
TEMPLATE_SPECIALIZATION
CStateMonsterAttackMoveToHomePointAbstract::CStateMonsterAttackMoveToHomePoint(_Object* obj, bool ignore_enemies_while_hide): inherited(obj), m_ignore_enemies_while_hide(ignore_enemies_while_hide)
{
    add_state(eStateAttack_HomePoint_Hide, xr_new<CStateMonsterMoveToPointEx<_Object>>(obj));
    add_state(eStateAttack_HomePoint_LookOpenPlace, xr_new<CStateMonsterLookToPoint<_Object>>(obj));
    add_state(eStateAttack_HomePoint_Camp, xr_new<CStateMonsterCustomAction<_Object>>(obj));
...
bool CStateMonsterAttackMoveToHomePointAbstract::check_completion()
{
    ...
    {
        if (object->EnemyMan.see_enemy_now() && object->Home->at_min_home(object->EnemyMan.get_enemy()->Position()))
            return true;
    }
