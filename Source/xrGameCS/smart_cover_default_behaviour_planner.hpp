...
namespace smart_cover
{
    ...
    class default_behaviour_planner: public CActionPlannerAction<animation_planner>, private boost::noncopyable, private debug::make_final<default_behaviour_planner>
    {
    private:
