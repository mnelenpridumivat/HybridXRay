...
void        CBulletManager::DynamicObjectHit(CBulletManager::_event& E)
{
    ...
    if (E.bullet.flags.allow_sendhit && !E.Repeated)
    {
        ...
        SHit Hit = SHit(hit_param.power, hit_param.power_critical, original_dir, NULL, u16(E.R.element), position_in_bone_space, hit_param.impulse, E.bullet.hit_type, E.bullet.armor_piercing, E.bullet.flags.aim_bullet);
...
bool        CBulletManager::ObjectHit(SBullet_Hit* hit_res, SBullet* bullet, const Fvector& end_point, collide::rq_result& R, u16 target_material, Fvector& hit_normal)
{
    ...
    *hit_res                = bullet->hit_param;   //default param
    ...
    float     shoot_factor  = 0.0f;   //default >> ���� �� ������� ��������!
