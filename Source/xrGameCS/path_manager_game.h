...
template<typename _DataStorage, typename _Parameters, typename _dist_type, typename _index_type, typename _iteration_type> class CPathManager<IGameGraph, _DataStorage, _Parameters, _dist_type, _index_type, _iteration_type>: public CPathManagerGeneric<IGameGraph, _DataStorage, _Parameters, _dist_type, _index_type, _iteration_type>
{
protected:
