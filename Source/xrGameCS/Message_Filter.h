...
public:
    ...
    void                    on_round_start_pause_impl(u32 message, u32 subtype, NET_Packet const& packet);
    void                    on_kill_pause_impl(u32 message, u32 subtype, NET_Packet const& packet);
    void                    on_artefactdelivering_pause_impl(u32 message, u32 subtype, NET_Packet const& packet);
