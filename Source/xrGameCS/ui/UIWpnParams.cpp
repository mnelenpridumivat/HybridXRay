...
void CUIWpnParams::SetInfo(CInventoryItem const* slot_wpn, CInventoryItem const& cur_wpn)
{
    ...
    float cur_damage  = (GameID() == eGameIDSingle) ? g_lua_wpn_params->m_functorDamage(cur_section, str_upgrades) : g_lua_wpn_params->m_functorDamageMP(cur_section, str_upgrades);
    ...
    if (slot_wpn && (slot_wpn != &cur_wpn))
    {
        ...
        slot_damage = (GameID() == eGameIDSingle) ? g_lua_wpn_params->m_functorDamage(slot_section, str_upgrades) : g_lua_wpn_params->m_functorDamageMP(slot_section, str_upgrades);
    }
