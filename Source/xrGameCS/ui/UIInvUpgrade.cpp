...
bool UIUpgrade::OnMouse(float x, float y, EUIMessages mouse_action)
{
    ...
    if ((mouse_action == WINDOW_LBUTTON_DOWN || mouse_action == WINDOW_LBUTTON_UP || mouse_action == WINDOW_RBUTTON_DOWN || mouse_action == WINDOW_RBUTTON_UP) && HasChildMouseHandler())
    {
        return false;
    }
