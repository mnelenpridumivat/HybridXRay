...
public:
    ...
    const Frect& GetOriginalRect() const
    {
        return m_UIStaticItem.GetOriginalRect();
    }
    //
    ...
    void SetOriginalRect_script(Frect* pr)
    {
        m_UIStaticItem.SetOriginalRect(*pr);
    }
    const Frect* GetOriginalRect_script()
    {
        return &m_UIStaticItem.GetOriginalRect();
    }
    ...
    {
        m_UIStaticItem.ResetHeadingPivot();
    }
    ...
    void SetConstHeading(bool b)
    {
        m_bConstHeading = b;
    };
    bool GetConstHeading()
    {
        return m_bConstHeading;
    }
