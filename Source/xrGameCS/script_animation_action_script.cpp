...
void CScriptAnimationAction::script_register(lua_State* L)
{
    module(L)[class_<CScriptAnimationAction>("anim")
                  .enum_("type")[value("free", int(MonsterSpace::eMentalStateFree)), value("danger", int(MonsterSpace::eMentalStateDanger)), value("panic", int(MonsterSpace::eMentalStatePanic))]
                  .enum_("monster")[value("stand_idle", int(MonsterSpace::eAA_StandIdle)), value("capture_prepare", int(MonsterSpace::eAA_CapturePrepare)), value("sit_idle", int(MonsterSpace::eAA_SitIdle)), value("lie_idle", int(MonsterSpace::eAA_LieIdle)), value("eat", int(MonsterSpace::eAA_Eat)), value("sleep", int(MonsterSpace::eAA_Sleep)), value("rest", int(MonsterSpace::eAA_Rest)), value("attack", int(MonsterSpace::eAA_Attack)), value("look_around", int(MonsterSpace::eAA_LookAround)),
