...
{
    Datas.insert({Key, xr_new<UICustomDataEditor>(Key, CustomData)});
}

void UILogicEditor::CloseCustomData(shared_str Key)
{
    Datas.erase(Key);
}

void UILogicEditor::SetVisible(bool Visible)
{
    this->Visible = Visible;
}

bool UILogicEditor::GetVisible()
{
    return Visible;
}
