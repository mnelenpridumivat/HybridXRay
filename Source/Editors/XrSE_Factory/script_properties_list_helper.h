...
public:
    ...
    Token8Value*
        CreateToken8(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name, CScriptTokenList* token);
    Token16Value*
        CreateToken16(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name, CScriptTokenList* token);
    Token32Value*
        CreateToken32(PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name, CScriptTokenList* token);
    //			RToken8Value* 		CreateRToken8	    (PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
    //RTokenVec* token); 			RToken16Value* 		CreateRToken16	    (PropItemVec* items, LPCSTR key, luabind::object
    //object, LPCSTR name, RTokenVec* token); 			RToken32Value* 		CreateRToken32	    (PropItemVec* items, LPCSTR key,
    ...
    VectorValue* CreateAngle3(
        ...
        float           inc,
        int             decim);
    //			RTextValue* 		CreateName		    (PropItemVec* items, LPCSTR key, luabind::object object, LPCSTR name,
    //ListItem* owner); 			RTextValue* 		CreateNameCB		(PropItemVec* items, LPCSTR key, luabind::object object,
    //LPCSTR name, TOnDrawTextEvent=0, RTextValue::TOnBeforeEditEvent=0, RTextValue::TOnAfterEditEvent=0);
