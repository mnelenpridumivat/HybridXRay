...
static void symmetric_subfrom(MxMatrix& A, const MxVector& a, const MxVector& b)
{
...
MxQuadric::MxQuadric(const MxVector& p1, const MxVector& p2, const MxVector& p3, double area): A(p1.dim()), b(p1.dim())
{
...
MxQuadric::MxQuadric(const MxQuadric3& Q3, unsigned int N): A(N), b(N)
{
    unsigned int i, j;
