...
private:
    ...
    inline float _ptof(unsigned char c) const
    {
...
#error "Packed color format illegal or left unspecified"
    ...
    float R() const
    {
        return _ptof(as.chan.r);
    }
    float G() const
    {
        return _ptof(as.chan.g);
    }
    float B() const
    {
        return _ptof(as.chan.b);
    }
};
...
private:
    ...
    inline float _stof(short s) const
    {
        return (float)s / (float)SHRT_MAX;
    }
    inline double _stod(short s) const
    {
        return (double)s / (double)SHRT_MAX;
    }
...
public:
    MxNormal() {}
    MxNormal(float x, float y, float z)
    {
        set(x, y, z);
    }
    MxNormal(const float* v)
    {
        set(v);
    }
    MxNormal(const double* v)
    {
        set(v);
    }
    ...
    short raw(unsigned int i) const
    {
        return dir[i];
    }
...
public:
    ...
    MxVertexID& operator()(int i)
    {
        return v[i];
    }
    MxVertexID operator()(int i) const
    {
        return v[i];
    }
    //
