...
extern double triangle_project_point(const Vec3& v0, const Vec3& v1, const Vec3& v2, const Vec3& v, Vec3* bary = NULL);
...
public:
    MxPlane3() {}
    MxPlane3(const float* p0)
    {
        for (unsigned int i = 0; i < 4; i++)
            p[i] = p0[i];
    }
    MxPlane3(const MxPlane3& n)
    {
        *this = n;
    }
