...
namespace lc_net
{
    ...
    template<> class tnet_execution_base<et_mu_base_light>::net_execution_impl
    {
        u32 mu_model_id;
    public:
        net_execution_impl(): mu_model_id(u32(-1)) {}

        void construct(u32 id)
        {
            mu_model_id = id;
        }
    ...
    template<> struct add_global<et_mu_base_light, gl_base_cl_data>
    {
    };
