...
public:
    ...
    ~xrLC_GlobalData();
    IC xr_vector<b_BuildTexture>& textures()
    {
        return _cl_globs._textures;
    }
    IC xr_vector<CLightmap*>& lightmaps()
    {
        return _g_lightmaps;
    }
    IC xr_vector<b_material>& materials()
    {
        return _cl_globs._materials;
    }
    IC Shader_xrLC_LIB& shaders()
    {
        return _cl_globs._shaders;
    }
    IC CMemoryWriter& err_invalid()
    {
        return _err_invalid;
    }
    IC CMemoryWriter& err_multiedge()
    {
        return _err_multiedge;
    };
    IC CMemoryWriter& err_tjunction()
    {
        return _err_tjunction;
    };
    IC b_params& g_params()
    {
    ...
    {
        return _g_deflectors;
    }
    bool b_r_vertices();
    bool vert_construct_register()
    {
        return !b_r_vertices() && !b_vert_not_register;
    }
    //		bool						b_r_faces		()		;
    base_lighting& L_static()
    {
        return _cl_globs._L_static;
    }
    CDB::MODEL* RCAST_Model()
    {
        return _cl_globs._RCAST_Model;
    }
