...
struct VIPM_SWR
{
    u32 offset;      // Offset of the first index in the index buffer to start at (note! no retrictions. Can easily be
                     // >64k)
...
extern "C"
{
    ...
    ETOOLS_API VIPM_Result*
        VIPM_Convert(u32 max_sliding_window = u32(-1), float error_tolerance = 0.1f, u32 optimize_vertex_order = 1);
