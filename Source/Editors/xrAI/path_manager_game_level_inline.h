...
#define CGameVertexTypePathManager CPathManager<CGameGraph, _DataStorage, SGameLevel<_dist_type, _index_type, _iteration_type>, _dist_type, _index_type, _iteration_type>
