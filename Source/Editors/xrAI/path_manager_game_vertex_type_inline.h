...
#define CGameVertexTypePathManager CPathManager<CGameGraph, _DataStorage, SVertexType<_dist_type, _index_type, _iteration_type>, _dist_type, _index_type, _iteration_type>
