...
public:
    MxPairContraction() {}
    MxPairContraction(const MxPairContraction& c)
    {
        *this = c;
    }
...
protected:
    ...
    unsigned int v_check_tag(MxVertexID i, unsigned int tag) const
    {
        return v_data(i).tag & tag;
    }
    void v_set_tag(MxVertexID i, unsigned int tag)
    {
        v_data(i).tag |= tag;
    }
    void v_unset_tag(MxVertexID i, unsigned int tag)
    {
        v_data(i).tag &= ~tag;
    }
    unsigned char vmark(MxVertexID i) const
    {
        return v_data(i).mark;
    }
    ...
    unsigned int f_check_tag(MxFaceID i, unsigned int tag) const
    {
        return f_data(i).tag & tag;
    }
    void f_set_tag(MxFaceID i, unsigned int tag)
    {
        f_data(i).tag |= tag;
    }
    void f_unset_tag(MxFaceID i, unsigned int tag)
    {
        f_data(i).tag &= ~tag;
    }
    unsigned char fmark(MxFaceID i) const
    {
        return f_data(i).mark;
    }
...
public:
    MxStdModel(unsigned int nvert, unsigned int nface): MxBlockModel(nvert, nface), v_data(nvert), f_data(nface), face_links(nvert) {}
    virtual ~MxStdModel();
    MxStdModel*  clone();
    ...
    void vertex_mark_valid(MxVertexID i)
    {
        v_set_tag(i, MX_VALID_FLAG);
    }
    void vertex_mark_invalid(MxVertexID i)
    {
        v_unset_tag(i, MX_VALID_FLAG);
    }

    unsigned int vertex_is_locked(MxVertexID i) const
    {
        return v_check_tag(i, MX_LOCK_FLAG);
    }
    void vertex_mark_locked(MxVertexID i)
    {
        v_set_tag(i, MX_LOCK_FLAG);
    }
    void vertex_mark_unlocked(MxVertexID i)
    {
        v_unset_tag(i, MX_LOCK_FLAG);
    }

    unsigned int face_is_valid(MxFaceID i) const
    {
        return f_check_tag(i, MX_VALID_FLAG);
    }
    void face_mark_valid(MxFaceID i)
    {
        f_set_tag(i, MX_VALID_FLAG);
    }
    void face_mark_invalid(MxFaceID i)
    {
        f_unset_tag(i, MX_VALID_FLAG);
    }

    unsigned int face_is_locked(MxFaceID i) const
    {
        return f_check_tag(i, MX_LOCK_FLAG);
    }
    void face_mark_locked(MxFaceID i)
    {
        f_set_tag(i, MX_LOCK_FLAG);
    }
    void face_mark_unlocked(MxFaceID i)
    {
        f_unset_tag(i, MX_LOCK_FLAG);
    }
    ...
    void vertex_mark_proxy(MxVertexID i)
    {
        v_set_tag(i, MX_PROXY_FLAG);
    }
    void vertex_mark_nonproxy(MxVertexID i)
    {
        v_unset_tag(i, MX_PROXY_FLAG);
    }
    ...
    void vertex_set_tag(MxVertexID i, unsigned int tag)
    {
        v_data(i).user_tag |= tag;
    }
    void vertex_unset_tag(MxVertexID i, unsigned int tag)
    {
        v_data(i).user_tag &= ~tag;
    }
    unsigned char vertex_mark(MxVertexID i)
    {
        return v_data(i).user_mark;
    }
    void vertex_mark(MxVertexID i, unsigned char m)
    {
        v_data(i).user_mark = m;
    }
    ...
    void face_set_tag(MxFaceID i, unsigned int tag)
    {
        f_data(i).user_tag |= tag;
    }
    void face_unset_tag(MxFaceID i, unsigned int tag)
    {
        f_data(i).user_tag &= ~tag;
    }
    unsigned char face_mark(MxFaceID i)
    {
        return f_data(i).user_mark;
    }
    void face_mark(MxFaceID i, unsigned char m)
    {
        f_data(i).user_mark = m;
    }
    ...
    const MxFaceList& neighbors(MxVertexID v) const
    {
        return *face_links(v);
    }
