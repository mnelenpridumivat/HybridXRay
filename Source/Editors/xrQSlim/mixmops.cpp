...
//
static double internal_solve(double* _a, double* b, const int N)
{
    int    i, j = 0, k;
...
// Uses Gaussian elimination with partial pivoting.
//
static double internal_invert(double* _a, double* _b, const int N)
{
