...
public:
    ...
    IC int _Priority()
    {
        return _Shader() ? _Shader()->E[0]->flags.iPriority : 1;
    }
    IC bool _StrictB2F()
    {
        return _Shader() ? _Shader()->E[0]->flags.bStrictB2F : false;
    }
    ...
    IC LPCSTR _ShaderName() const
    {
        return *m_ShaderName;
    }
    IC LPCSTR _GameMtlName() const
    {
        return *m_GameMtlName;
    }
    IC LPCSTR _ShaderXRLCName() const
    {
        return *m_ShaderXRLCName;
    }
    IC LPCSTR _Texture() const
    {
        return *m_Texture;
    }
    IC LPCSTR _VMap() const
    {
        return *m_VMap;
    }
    IC u32 _FVF() const
    ...
    IC void SetShaderXRLC(LPCSTR name)
    {
        m_ShaderXRLCName = name;
    }
    IC void SetGameMtl(LPCSTR name)
    {
        m_GameMtlName = name;
    }
    IC void SetFVF(u32 fvf)
    {
        m_dwFVF = fvf;
    }
    ...
    {
        return GameMaterialLibrary->GetMaterialID(*m_GameMtlName);
    }
...
public:
    ...
    IC BOOL IsDynamic()
    {
        return m_objectFlags.is(eoDynamic);
    }
    IC BOOL IsStatic()
    {
...
public:
    ...
    IC EditMeshIt FirstMesh()
    {
        return m_Meshes.begin();
    }
    IC EditMeshIt LastMesh()
    {
        return m_Meshes.end();
    }
    IC EditMeshVec& Meshes()
    {
        return m_Meshes;
    }
    IC int MeshCount()
    ...
    IC void AppendMesh(CEditableMesh* M)
    {
        m_Meshes.push_back(M);
    }
    IC SurfaceVec& Surfaces()
    {
        return m_Surfaces;
    }
    IC SurfaceIt FirstSurface()
    {
        return m_Surfaces.begin();
    }
    IC SurfaceIt LastSurface()
    {
    ...
    LPCSTR    GetLODShaderName()
    {
        return LOD_SHADER_NAME;
    }
    void GetLODFrame(int frame, Fvector p[4], Fvector2 t[4], const Fmatrix* parent = 0);

    // skeleton
    IC BPIt FirstBonePart()
    {
        return m_BoneParts.begin();
    }
    IC BPIt LastBonePart()
    {
        return m_BoneParts.end();
    }
    IC BPVec& BoneParts()
    {
        return m_BoneParts;
    }
    IC int BonePartCount()
    {
        return m_BoneParts.size();
    }
    ...
    IC SMotionIt FirstSMotion()
    {
        return m_SMotions.begin();
    }
    IC SMotionIt LastSMotion()
    {
        return m_SMotions.end();
    }
    SMotionVec& SMotions()
    {
        return m_SMotions;
    ...
    IC int SMotionCount()
    {
        return m_SMotions.size();
    }
    IC bool IsAnimated()
    {
        return SMotionCount() || m_SMotionRefs.size();
    }
    IC void SkeletonPlay()
    {
        m_SMParam.Play();
    }
    IC void SkeletonStop()
    {
        m_SMParam.Stop();
    }
    IC void SkeletonPause(bool val)
    {
        m_SMParam.Pause(val);
    }
    ...
    IC xr_string& GetClassScript()
    {
        return m_ClassScript;
    }

    IC const Fbox& _BCL GetBox() const
    {
        return m_BBox;
    }
    ...
    IC bool IsSMotionActive()
    {
        return IsSkeleton() && m_ActiveSMotion;
    }
    CSMotion* GetActiveSMotion()
    {
        return m_ActiveSMotion;
    }
...
private:
    ...
    // Low level interface
    virtual u16 _BCL LL_BoneID(LPCSTR B)
    {
        int id = FindBoneByNameIdx(B);
        VERIFY(id < u16(-1));
        return (u16)id;
    }
    virtual u16 _BCL LL_BoneID(const shared_str& B)
    {
        return LL_BoneID(B.c_str());
    }
    virtual LPCSTR _BCL LL_BoneName_dbg(u16 ID);

    virtual CInifile* _BCL LL_UserData()
    {
        return 0;
    }
    ...
    virtual u16 _BCL LL_BoneCount() const
    {
        return (u16)BoneCount();
    }
    ...
    virtual ICF Fmatrix& _BCL LL_GetTransform(u16 bone_id)
    {
        return GetBone(bone_id)->_LTransform();
    }
    virtual ICF const Fmatrix& _BCL LL_GetTransform(u16 bone_id) const
    {
        return GetBone(bone_id)->_LTransform();
    }
    ...
    virtual u16 _BCL LL_GetBoneRoot()
    {
    ...
    virtual BOOL _BCL LL_GetBoneVisible(u16 bone_id)
    {
        return TRUE;
    }
    ...
    virtual BonesVisible _BCL LL_GetBonesVisible()
    {
        return BonesVisible(-1);
    }
    virtual void LL_SetBonesVisible(BonesVisible mask)
    {
        VERIFY(false);
    }
