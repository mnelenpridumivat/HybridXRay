...
public:
    ...
    IC u32 _Width()
    {
        return m_TexParams.width;
    }
    IC u32 _Height()
    {
        return m_TexParams.height;
    }
    IC u32 _Alpha()
    {
        return m_TexParams.HasAlphaChannel();
    }
    // thumbnail public routines
    IC STextureParams& _Format()
    {
        return m_TexParams;
    }
    ...
    virtual bool Valid()
    {
        return m_bValid; /*return !m_Pixels.empty();*/
    }
    void SetValid()
    {
        m_bValid = true;
