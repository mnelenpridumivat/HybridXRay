...
class ECORE_API CEStats: public CStatsPhysics, public CStats
{
public:
...
#define UPDATEC(vert, poly, pass)                      \
    {                                                  \
        EDevice->Statistic->dwVert += (vert) * (pass); \
        EDevice->Statistic->dwPoly += (poly)*pass;     \
        EDevice->Statistic->dwCalls += pass;           \
    }
