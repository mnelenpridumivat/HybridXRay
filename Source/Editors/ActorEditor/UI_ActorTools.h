...
protected:
    ...
    void RefreshShaders()
    {
        m_Flags.set(flRefreshShaders, TRUE);
    }
    void MakeThumbnail()
    {
        m_Flags.set(flMakeThumbnail, TRUE);
    }
    void GenerateLOD(bool hq)
    {
        m_Flags.set(hq ? flGenerateLODHQ : flGenerateLODLQ, TRUE);
    }
...
public:
    ...
    bool IsVisualPresent()
    {
        return m_RenderObject.IsRenderable();
    }

    CEditableObject* CurrentObject()
    {
