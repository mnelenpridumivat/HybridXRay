...
{
    module(L)[class_<PropValue>("prop_value"), class_<PropItemVec>("prop_item_vec"), class_<CaptionValue>("caption_value"), class_<CanvasValue>("canvas_value"), class_<ButtonValue>("button_value"), class_<ChooseValue>("choose_value"), class_<S8Value>("s8_value"), class_<S16Value>("s16_value"), class_<S32Value>("s32_value"), class_<U8Value>("u8_value"), class_<U16Value>("u16_value"), class_<U32Value>("u32_value"), class_<FloatValue>("u32_value"), class_<BOOLValue>("bool_value"),
        class_<VectorValue>("vector_value"), class_<ColorValue>("color_value"), class_<RTextValue>("text_value"), class_<Flag8Value>("flag8_value"), class_<Flag16Value>("flag16_value"), class_<Flag32Value>("flag32_value"), class_<Token8Value>("token8_value"), class_<Token16Value>("token16_value"), class_<Token32Value>("token32_value"),
        ...
        class_<CChooseType>("choose_type")
            .enum_("choose_type")[value("custom", int(smCustom)), value("sound_source", int(smSoundSource)), value("sound_environment", int(smSoundEnv)), value("library_object", int(smObject)), value("engine_shader", int(smEShader)), value("compiler_shader", int(smCShader)), value("particle_effect", int(smPE)), value("particle_system", int(smParticles)), value("texture", int(smTexture)), value("entity", int(smEntityType)), value("spawn_item", int(smSpawnItem)),
                value("light_animation", int(smLAnim)), value("visual", int(smVisual)), value("skeleton_animations", int(smSkeletonAnims)), value("skeleton_bones", int(smSkeletonBones)), value("material", int(smGameMaterial)), value("game_animation", int(smGameAnim)), value("game_motion", int(smGameSMotions))],
