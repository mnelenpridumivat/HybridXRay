...
void ConvertAlphaToNormalMap_3x3(NVI_Image* pSrc, float scale, bool wrap)
{
    ...
    //  -1/6	0	1/6
    //  -1/6	0	1/6
    ConvolutionKernelElement du_elem[] = {{-1, 1, -wt}, {1, 1, wt},    {-1, 0, -wt},
                                          {1, 0, wt},   {-1, -1, -wt}, {1, -1, wt}};
    ...
    //  -1/6	-1/6	-1/6
    // 0,0
    ConvolutionKernelElement dv_elem[]   = {{-1, 1, wt},   {0, 1, wt},   {1, 1, wt},
...
void ConvertAlphaToNormalMap_5x5(NVI_Image* pSrc, float scale, bool wrap)
{
    ...
    */
    ...
    ConvolutionKernelElement du_elem[] = {{-2, 2, -wt22},  {-1, 2, -wt12},  {1, 2, wt12},  {2, 2, wt22},
...
void ConvertAlphaToNormalMap_7x7(NVI_Image* pSrc, float scale, bool wrap)
{
    ...
    numelem      = 49;
    float du_f[] = {-1, -2, -3, 0,  3,  2,  1, -2, -3, -4, 0,  4,  3,  2, -3, -4, -5, 0,  5,  4,  3, -4, -5, -6, 0,
                    6,  5,  4,  -3, -4, -5, 0, 5,  4,  3,  -2, -3, -4, 0, 4,  3,  2,  -1, -2, -3, 0, 3,  2,  1};
...
void ConvertAlphaToNormalMap_9x9(NVI_Image* pSrc, float scale, bool wrap)
{
    ...
    // A Sobel filter kernel
    numelem      = 81;
    float du_f[] = {-1, -2, -3, -4, 0, 4, 3, 2, 1, -2, -3, -4, -5, 0, 5, 4, 3, 2, -3, -4, -5, -6, 0, 6, 5, 4, 3,
                    -4, -5, -6, -7, 0, 7, 6, 5, 4, -5, -6, -7, -8, 0, 8, 7, 6, 5, -4, -5, -6, -7, 0, 7, 6, 5, 4,
                    -3, -4, -5, -6, 0, 6, 5, 4, 3, -2, -3, -4, -5, 0, 5, 4, 3, 2, -1, -2, -3, -4, 0, 4, 3, 2, 1};
...
void ConvertToNormalMap(NVI_Image* pSrc, KernelType kt, float scale)
{
    ...
    {
        case KERNEL_4x:
            ConvertAlphaToNormalMap_4x(pSrc, scale, true);
            break;
        case KERNEL_3x3:
            ConvertAlphaToNormalMap_3x3(pSrc, scale, true);
            break;
        case KERNEL_5x5:
            ConvertAlphaToNormalMap_5x5(pSrc, scale, true);
            break;
        case KERNEL_7x7:
            ConvertAlphaToNormalMap_7x7(pSrc, scale, true);
            break;
        case KERNEL_9x9:
            ConvertAlphaToNormalMap_9x9(pSrc, scale, true);
            break;
        default:
            NODEFAULT;
    }
