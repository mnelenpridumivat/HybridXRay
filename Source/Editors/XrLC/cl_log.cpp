...
{
    virtual void clMsg(LPCSTR msg)
    {
        ::clMsg(msg);
    }
    virtual void clLog(LPCSTR msg)
    {
        ::clLog(msg);
    }
    virtual void Status(LPCSTR msg)
    {
        ::Status(msg);
    }
    virtual void Progress(const float F)
    {
        ::Progress(F);
    }
    virtual void Phase(LPCSTR phase_name)
    {
        ::Phase(phase_name);
    }
