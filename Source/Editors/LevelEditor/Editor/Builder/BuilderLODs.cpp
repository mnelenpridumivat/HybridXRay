        ...
        for (u32 sample_idx=0; sample_idx<LOD_SAMPLE_COUNT; sample_idx++){
            ...
            for (s32 iH=0; iH<LOD_IMAGE_SIZE; iH++){
                ...
                for (s32 iW=0; iW<LOD_IMAGE_SIZE; iW++){
                    ...
                    u32 pixel		=
    (LOD_IMAGE_SIZE-iH-1)*LOD_SAMPLE_COUNT*LOD_IMAGE_SIZE+LOD_IMAGE_SIZE*sample_idx+iW; u32& tgt_n		=
    b.ndata[pixel]; u8& tgt_h		= hemi_temp[pixel]; u8 src_a		= color_get_A	(b.data[pixel]);
