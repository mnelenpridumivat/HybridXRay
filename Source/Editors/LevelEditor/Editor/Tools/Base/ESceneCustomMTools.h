...
public:
    ...
    BOOL    IsEnabled()
    {
        return m_EditFlags.is(flEnable);
    }
    BOOL IsEditable()
    {
        return !m_EditFlags.is_any(flReadonly | flForceReadonly);
    }
    BOOL IsReadonly()
    {
        return m_EditFlags.is(flReadonly);
    }
    BOOL IsForceReadonly()
    {
        return m_EditFlags.is(flForceReadonly);
    }
    BOOL IsChanged()
    {
        return m_EditFlags.is(flChanged);
    }
    void SetChanged(BOOL b)
    {
        m_EditFlags.set(flChanged, b);
    }
    BOOL IsVisible()
    {
        return m_EditFlags.is(flVisible);
    }
