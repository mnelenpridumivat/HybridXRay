...
struct SIndexDist
{
    ...
    SIndexDist()
    {
        ZeroMemory(this, sizeof(SIndexDist));
    }
};
...
//	public pureDeviceDestroy
{
    ...
    IC u32 toSlotZ(float z)
    {
        return (z / DETAIL_SLOT_SIZE + 0.5f) + dtH.offs_z;
    }
...
public:
    ...
    virtual bool Valid()
    {
        return dtSlots || objects.size() || m_Base.Valid() || m_SnapObjects.size();
    }
