...
void CLevelMain::RegisterCommands()
{
    ...
    APPEND_SUB_CMD("Object", xr_shortcut('1', false, false, false), OBJCLASS_SCENEOBJECT, 0);
    APPEND_SUB_CMD("Light", xr_shortcut('2', false, false, false), OBJCLASS_LIGHT, 0);
    APPEND_SUB_CMD("Sound Source", xr_shortcut('3', false, false, false), OBJCLASS_SOUND_SRC, 0);
    APPEND_SUB_CMD("Sound Env", xr_shortcut('4', false, false, false), OBJCLASS_SOUND_ENV, 0);
    APPEND_SUB_CMD("Glow", xr_shortcut('5', false, false, false), OBJCLASS_GLOW, 0);
    APPEND_SUB_CMD("Shape", xr_shortcut('6', false, false, false), OBJCLASS_SHAPE, 0);
    APPEND_SUB_CMD("Spawn Point", xr_shortcut('7', false, false, false), OBJCLASS_SPAWNPOINT, 0);
    APPEND_SUB_CMD("Way", xr_shortcut('8', false, false, false), OBJCLASS_WAY, 0);
    APPEND_SUB_CMD("Way Point", xr_shortcut('8', false, true, false), OBJCLASS_WAY, 1);
    APPEND_SUB_CMD("Toggle Way Mode", xr_shortcut('Q', false, false, false), OBJCLASS_WAY, 2);
    APPEND_SUB_CMD("Sector", xr_shortcut('0', false, false, false), OBJCLASS_SECTOR, 0);
    APPEND_SUB_CMD("Portal", xr_shortcut('9', false, false, false), OBJCLASS_PORTAL, 0);
    APPEND_SUB_CMD("Group", xr_shortcut('1', false, true, false), OBJCLASS_GROUP, 0);
    APPEND_SUB_CMD("Particle System", xr_shortcut('2', false, true, false), OBJCLASS_PS, 0);
    APPEND_SUB_CMD("Detail Objects", xr_shortcut('3', false, true, false), OBJCLASS_DO, 0);
    APPEND_SUB_CMD("AI Map", xr_shortcut('4', false, true, false), OBJCLASS_AIMAP, 0);
    APPEND_SUB_CMD("Static Wallmark", xr_shortcut('5', false, true, false), OBJCLASS_WM, 0);
    ...
    REGISTER_CMD_CE(COMMAND_SHOW_OBJECTLIST, "Scene\\Show Object List", xr_shortcut('W', false, true, false), LTools, CLevelTool::CommandShowObjectList, false);
    // common
    ...
    REGISTER_CMD_SE(COMMAND_LOAD, "File\\Load Level", xr_shortcut('L', false, true, false), CommandLoad, true);
    ...
    REGISTER_CMD_SE(COMMAND_CLEAR, "File\\Clear Scene", xr_shortcut('N', false, true, false), CommandClear, true);
    ...
    REGISTER_CMD_SE(COMMAND_CUT, "Edit\\Cut", xr_shortcut('X', false, true, false), CommandCut, false);
    REGISTER_CMD_SE(COMMAND_COPY, "Edit\\Copy", xr_shortcut('C', false, true, false), CommandCopy, false);
    REGISTER_CMD_SE(COMMAND_DUPLICATE, "Edit\\Duplicate", xr_shortcut(), CommandDuplicate, false);
    REGISTER_CMD_SE(COMMAND_PASTE, "Edit\\Paste", xr_shortcut('V', false, true, false), CommandPaste, false);
    REGISTER_CMD_S(COMMAND_LOAD_SELECTION, CommandLoadSelection);
    REGISTER_CMD_S(COMMAND_SAVE_SELECTION, CommandSaveSelection);
    REGISTER_CMD_SE(COMMAND_UNDO, "Edit\\Undo", xr_shortcut('Z', false, true, false), CommandUndo, false);
    REGISTER_CMD_SE(COMMAND_REDO, "Edit\\Redo", xr_shortcut('Y', false, true, false), CommandRedo, false);
    ...
    REGISTER_CMD_SE(COMMAND_OPTIONS, "Scene\\Options", xr_shortcut('O', false, true, false), CommandOptions, false);
    REGISTER_CMD_SE(COMMAND_BUILD, "Compile\\Build", xr_shortcut(VK_F9, false, false, false), CommandBuild, false);
    ...
    REGISTER_CMD_SE(COMMAND_SELECT_ALL, "Selection\\Select All", xr_shortcut('A', false, true, false), CommandSelectAll, false);
    REGISTER_CMD_SE(COMMAND_DESELECT_ALL, "Selection\\Unselect All", xr_shortcut(VK_SPACE, false, false, false), CommandDeselectAll, false);
    REGISTER_CMD_SE(COMMAND_DELETE_SELECTION, "Edit\\Delete", xr_shortcut(VK_DELETE, false, false, false), CommandDeleteSelection, false);
    REGISTER_CMD_SE(COMMAND_HIDE_UNSEL, "Visibility\\Hide Unselected", xr_shortcut(VK_OEM_PLUS, false, false, false), CommandHideUnsel, false);
    REGISTER_CMD_SE(COMMAND_HIDE_SEL, "Visibility\\Hide Selected", xr_shortcut(VK_OEM_MINUS, false, false, false), CommandHideSel, false);
    REGISTER_CMD_SE(COMMAND_HIDE_ALL, "Visibility\\Hide All", xr_shortcut(), CommandHideAll, false);
    ...
    REGISTER_CMD_SE(COMMAND_TOGGLE_AIMAP_VISIBILITY, "Visibility\\Toggle AIMap", xr_shortcut(VK_OEM_5, false, false, false), CommandToggleAiMapVisibility, true);
