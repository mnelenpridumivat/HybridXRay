...
class CSpawnPoint: public CCustomObject, public CPhysicsShellHolderEditorBase
{
...
public:
    ...
    struct SSpawnData: public ISE_AbstractLEOwner
    {
        ...
        IC ISE_Abstract* GetEntity() const
        {
            return m_Data;
        }
    };
...
public:
    IC ISE_Abstract* GetEntity()
    {
        PreExportSpawn();
        return m_SpawnData.GetEntity();
    }
