...
inline void ARGBToAlphaAndVector(const rgba_t& inColor, unsigned long& theHeight, fpPixel& outVector)
{
...
__forceinline void AlphaAndVectorToQ8W8V8U8(unsigned long theHeight, float fq, float fw, float fv, q8w8v8u8_t& outColor)
{
...
__forceinline void RGBToFloat(rgba_t inColor, float* outAlpha, float* outRed, float* outGreen, float* outBlue)
{
...
__forceinline void RGBToFloat(rgba_t inColor, double* outAlpha, double* outRed, double* outGreen, double* outBlue)
{
    // Converts RGB [0,255] to float [0,1]
...
__forceinline void RGBToFloatVector(rgba_t inColor, double* outAlpha, double* outRed, double* outGreen, double* outBlue)
{
    // Converts RGB [0,255] to float [-1,1]
    // Use if RGB is a vector from a normal map
...
inline void AlphaAndVectorToARGB(const unsigned long& theHeight, const fpPixel& inVector, rgba_t& outColor)
{
