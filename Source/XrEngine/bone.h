...
public:
    ...
    void _BCL set_callback_overwrite(BOOL v)
    {
        Callback_overwrite = v;
    }
...
class ENGINE_API CBone: public CBoneInstance, public IBoneData
{
    shared_str name;
...
public:
    ...
    IC const Fmatrix& _LTransform() const
    {
        return mTransform;
    }
...
public:
    ...
    IC u16 _BCL GetSelfID() const
    {
        return SelfID;
    }
    IC u16 _BCL GetParentID() const
    {
        return ParentID;
    }
