...
template <> void property_collection<flares::flares_type, flares>::display_name(
...
void flares::load(CInifile& config, shared_str const& section)
{
    ...
    shared_str flare_textures = READ_IF_EXISTS(
        &config, r_string, section, "flare_textures",
    ...
    XrWeatherEditor::property_holder_collection* collection)
{
    ...
    properties->add_property(
        "shader", "flares", "this option is resposible for flares shader", m_shader.c_str(), m_shader,
