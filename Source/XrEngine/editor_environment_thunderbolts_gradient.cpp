    ...
    ::XrWeatherEditor::property_holder&      holder)
{
    ...
    m_property_holder->add_property(
        "minimum radius", "properties", "this option is resposible for thunderbolt gradient minimum radius", fRadius.x,
        fRadius.x);
    m_property_holder->add_property(
        "maximum _radius", "properties", "this option is resposible for thunderbolt gradient maximum radius", fRadius.y,
        fRadius.y);
    ...
    m_property_holder->add_property(
        "shader", "properties", "this option is resposible for thunderbolt gradient shader", shader.c_str(),
        string_getter, string_setter, &*environment.shader_ids().begin(), environment.shader_ids().size(),
    ...
    m_property_holder->add_property(
        "texture", "", "this option is resposible for thunderbolt gradient texture", texture.c_str(), texture, ".dds",
