...
public:
    template <typename _iterator_type> IC associative_vector(
        _iterator_type        first,
        _iterator_type        last,
        const key_compare&    predicate = key_compare(),
        const allocator_type& allocator = allocator_type());
    IC associative_vector(
        const key_compare&    predicate = key_compare(),
        const allocator_type& allocator = allocator_type());
...
template <typename _key_type, typename _data_type, typename _compare_predicate_type> IC void swap(
