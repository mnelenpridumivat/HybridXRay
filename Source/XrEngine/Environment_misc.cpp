...
void CEnvDescriptor::load(CEnvironment& environment, CInifile& config)
{
    ...
    tb_id = environment.eff_Thunderbolt->AppendDef(
        environment, environment.m_thunderbolt_collections_config, environment.m_thunderbolts_config,
...
IEnvAmbient* CEnvironment::AppendEnvAmb(const shared_str& sect)
{
    ...
    Ambient->load(*m_ambients_config, *m_sound_channels_config, *m_effects_config, sect);
