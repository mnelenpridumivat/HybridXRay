...
struct test_property
{
    ...
    int xr_stdcall getter()
    {
        return m_property;
    }
    void xr_stdcall setter(int value)
    {
        m_property = value;
    }
};
...
struct test_property4
{
    ...
    bool xr_stdcall getter()
    {
        return m_property;
    }
    void xr_stdcall setter(bool value)
    {
        m_property = value;
    }
};
...
struct test_property7
{
    ...
    float xr_stdcall getter()
    {
        return m_property;
    }
    void xr_stdcall setter(float value)
    {
        m_property = value;
    }
};
