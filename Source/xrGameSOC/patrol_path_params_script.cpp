...
void CPatrolPathParams::script_register(lua_State* L)
{
    module(L)[class_<CPatrolPathParams>("patrol")
                  .enum_("start")[value("start", int(PatrolPathManager::ePatrolStartTypeFirst)), value("stop", int(PatrolPathManager::ePatrolStartTypeLast)), value("nearest", int(PatrolPathManager::ePatrolStartTypeNearest)), value("custom", int(PatrolPathManager::ePatrolStartTypePoint)), value("next", int(PatrolPathManager::ePatrolStartTypeNext)), value("dummy", int(PatrolPathManager::ePatrolStartTypeDummy))]
                  .enum_("stop")[value("stop", int(PatrolPathManager::ePatrolRouteTypeStop)), value("continue", int(PatrolPathManager::ePatrolRouteTypeContinue)), value("dummy", int(PatrolPathManager::ePatrolRouteTypeDummy))]
