...
private:
    ...
    IC void        AnimGoal(Fmatrix& gl, IKinematics& K);
...
struct SCalculateData: private boost::noncopyable
{
    ...
    SCalculateData(CIKLimb& l, IKinematics* K, const Fmatrix& o): m_limb(l), m_obj(o), m_K(K), m_angles(0), apply(false), do_collide(false), foot_step(false) {}
};
