...
bool CGameSpy_QR2::Init(int PortID, int Public, void* instance)
{
    ...
    if (xrGS_qr2_initA(NULL, NULL, PortID, Public, 0, callback_serverkey, callback_playerkey, callback_teamkey, callback_keylist, callback_count, callback_adderror, instance) != e_qrnoerror)
    {
