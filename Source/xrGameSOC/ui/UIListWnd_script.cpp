...
void CUIListWnd::script_register(lua_State* L)
{
    module(L)[
        ...
        class_<enum_exporter<EGameTypes>>("GAME_TYPE").enum_("gametype")[value("GAME_UNKNOWN", int(GAME_ANY)), value("GAME_DEATHMATCH", int(GAME_DEATHMATCH)), value("GAME_TEAMDEATHMATCH", int(GAME_TEAMDEATHMATCH)), value("GAME_ARTEFACTHUNT", int(GAME_ARTEFACTHUNT))], def("xrRender_test_r2_hw", &xrRender_test_hw_script)
