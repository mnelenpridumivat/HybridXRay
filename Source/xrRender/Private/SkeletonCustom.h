...
public:
    ...
    {
        VERIFY(bone_id < LL_BoneCount());
        return bonesvisible.is(bone_id);
    }
    void              LL_SetBoneVisible(u16 bone_id, BOOL val, BOOL bRecursive);
    BonesVisible _BCL LL_GetBonesVisible()
    {
        return bonesvisible;
    }
...
public:
    ...
    virtual IKinematics* _BCL dcast_PKinematics()
    {
        return this;
    }
