...
TEMPLATE_SPECIALIZATION
template<class other> MEMORY_ALLOCATOR::memory_allocator(memory_allocator<other> const&) {}

TEMPLATE_SPECIALIZATION
template<class other> MEMORY_ALLOCATOR& MEMORY_ALLOCATOR::operator=(memory_allocator<other> const&)
{
    return (*this);
}
...
namespace luabind
{
    ...
    template<class _0, class _1> inline bool operator==(memory_allocator<_0> const&, memory_allocator<_1> const&)
    {
        return (true);
    }
