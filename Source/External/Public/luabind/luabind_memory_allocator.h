...
namespace luabind
{
    ...
    template<class T> class memory_allocator
    {
    private:
    ...
    public:
        template<class _1> struct rebind
        {
    ...
    public:
        template<class _1> inline memory_allocator(const memory_allocator<_1>&);

    public:
        template<class _1> inline memory_allocator<T>& operator=(const memory_allocator<_1>&);
    ...
    template<class _0, class _1> inline bool operator==(const memory_allocator<_0>&, const memory_allocator<_1>&);
