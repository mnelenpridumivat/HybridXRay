...
#define D_ALL_PARAM_NAMES(start)                                                                                                                                         \
    ...
    dParamLoStop = start, dParamHiStop, dParamVel, dParamFMax, dParamFudgeFactor, dParamBounce, dParamCFM, dParamStopERP, dParamStopCFM, /* parameters for suspension */ \
        dParamSuspensionERP, dParamSuspensionCFM,

#define D_ALL_PARAM_NAMES_X(start, x)                                                                                                                                                               \
    /* parameters for limits and motors */                                                                                                                                                          \
    dParamLoStop##x = start, dParamHiStop##x, dParamVel##x, dParamFMax##x, dParamFudgeFactor##x, dParamBounce##x, dParamCFM##x, dParamStopERP##x, dParamStopCFM##x, /* parameters for suspension */ \
