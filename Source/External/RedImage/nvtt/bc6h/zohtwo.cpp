...
static const int mode_to_pat[MAXMODES] = {3,   // 0x00
    8,                                         // 0x01
    0,                                         // 0x02
    -1, -1, -1,
    1,   // 0x06
    ...
    while (ptr)
    {
        ...
        switch (field)
        {
            ...
            case FIELD_RX:
                ...
                break;
            case FIELD_RY:
                out.write(ry >> endbit, len);
                break;
            case FIELD_RZ:
                out.write(rz >> endbit, len);
                break;
            case FIELD_GW:
            ...
            case FIELD_GX:
                ...
                break;
            case FIELD_GY:
                out.write(gy >> endbit, len);
                break;
            case FIELD_GZ:
                out.write(gz >> endbit, len);
                break;
            case FIELD_BW:
            ...
            case FIELD_BX:
                ...
                break;
            case FIELD_BY:
                out.write(by >> endbit, len);
                break;
            case FIELD_BZ:
                out.write(bz >> endbit, len);
                break;
            default:
                nvUnreachable();
        }
    ...
    while (ptr)
    {
        ...
        switch (field)
        {
            ...
            case FIELD_RX:
                ...
                break;
            case FIELD_RY:
                ry |= in.read(len) << endbit;
                break;
            case FIELD_RZ:
                rz |= in.read(len) << endbit;
                break;
            case FIELD_GW:
            ...
            case FIELD_GX:
                ...
                break;
            case FIELD_GY:
                gy |= in.read(len) << endbit;
                break;
            case FIELD_GZ:
                gz |= in.read(len) << endbit;
                break;
            case FIELD_BW:
            ...
            case FIELD_BX:
                ...
                break;
            case FIELD_BY:
                by |= in.read(len) << endbit;
                break;
            case FIELD_BZ:
                bz |= in.read(len) << endbit;
                break;
            default:
                nvUnreachable();
        }
...
static void assign_indices(const Tile& tile, int shapeindex, IntEndpts endpts[NREGIONS_TWO], int prec, int indices[Tile::TILE_H][Tile::TILE_W], float toterr[NREGIONS_TWO])
{
...
static void optimize_endpts(const Tile& tile, int shapeindex, const float orig_err[NREGIONS_TWO], const IntEndpts orig_endpts[NREGIONS_TWO], int prec, IntEndpts opt_endpts[NREGIONS_TWO])
{
