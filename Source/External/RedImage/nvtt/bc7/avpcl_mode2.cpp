...
static void assign_indices(const Tile& tile, int shapeindex, IntEndptsRGB endpts[NREGIONS_THREE], const PatternPrec& pattern_prec, int indices[Tile::TILE_H][Tile::TILE_W], float toterr[NREGIONS_THREE])
{
...
static float perturb_one(const Vector4 colors[], const float importance[], int np, int ch, const RegionPrec& region_prec, const IntEndptsRGB& old_endpts, IntEndptsRGB& new_endpts, float old_err, int do_b, int indices[Tile::TILE_TOTAL])
{
...
static void optimize_endpts(const Tile& tile, int shapeindex, const float orig_err[NREGIONS_THREE], const IntEndptsRGB orig_endpts[NREGIONS_THREE], const PatternPrec& pattern_prec, float opt_err[NREGIONS], IntEndptsRGB opt_endpts[NREGIONS_THREE])
{
