...
#define OC_LOOP_FILTER_V_MMX(_pix, _ystride, _ll)                                                                 \
    ...
    {                                                                                                             \
       ...
       "error C2425: 'SHL' : non-constant expression in 'second operand'".*/                                   \
        ...
        ll__  = (_ll);                                                                                            \
        pix__ = (_pix);                                                                                           \
        __asm mov YSTRIDE, _ystride __asm mov LL, ll__ __asm mov PIX, pix__ __asm sub PIX, YSTRIDE __asm sub PIX, \
            YSTRIDE /*mm0={a0,...,a7}*/                                                                           \
            __asm movq mm0,                                                                                       \
    ...
    {                                                                                                                         \
       ...
       "error C2443: operand size conflict".*/                                                \
        ...
        __asm mov PIX, pix__ __asm mov YSTRIDE, _ystride __asm mov LL,                                                        \
            ...
            mm2 /*[d]=c1 b1 c0 b0*/                                                                                           \
            __asm movd D,                                                                                                     \
            mm1 __asm mov[PIX + 1], D_WORD __asm psrlq mm1, 32 __asm shr D, 16 __asm mov[PIX + YSTRIDE + 1],                  \
            D_WORD /*[d]=c3 b3 c2 b2*/                                                                                        \
            __asm movd D,                                                                                                     \
            mm1 __asm mov[PIX + YSTRIDE * 2 + 1], D_WORD __asm shr D, 16 __asm mov[PIX + YSTRIDE3 + 1], D_WORD __asm lea PIX, \
            [PIX + YSTRIDE * 4] /*[d]=c5 b5 c4 b4*/                                                                           \
            __asm movd D,                                                                                                     \
            mm0 __asm mov[PIX + 1], D_WORD __asm psrlq mm0, 32 __asm shr D, 16 __asm mov[PIX + YSTRIDE + 1],                  \
            D_WORD /*[d]=c7 b7 c6 b6*/                                                                                        \
            __asm movd D,                                                                                                     \
            mm0 __asm mov[PIX + YSTRIDE * 2 + 1], D_WORD __asm shr D, 16 __asm mov[PIX + YSTRIDE3 + 1], D_WORD                \
    }                                                                                                                         \
    while (0)
