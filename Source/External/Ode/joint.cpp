...
static inline void setBall2(dxJoint* joint, dxJoint::Info2* info, dVector3 anchor1, dVector3 anchor2, dVector3 axis, dReal erp1)
{
    // anchor points in global coordinates with respect to body PORs.
    dVector3 a1, a2;
        ...
        if (limit)
        {
            ...
            else
            {
                ...
                if (bounce > 0)
                {
                    ...
                    if (rotational)
                    {
                        vel1 = dDOT(joint->node[0].body->avel, ax1);
                        if (joint->node[1].body)
                            vel1 -= dDOT(joint->node[1].body->avel, ax1);
                    }
                    else
                    {
                        vel1 = dDOT(joint->node[0].body->lvel, ax1);
                        if (joint->node[1].body)
                            vel1 -= dDOT(joint->node[1].body->lvel, ax1);
                    }
...
dxJoint::Vtable __dball_vtable = {sizeof(dxJointBall), (dxJoint::init_fn*)ballInit, (dxJoint::getInfo1_fn*)ballGetInfo1, (dxJoint::getInfo2_fn*)ballGetInfo2, dJointTypeBall
#ifdef DE_PADF_INTEGRATION
    ,
...
dxJoint::Vtable __dhinge_vtable = {sizeof(dxJointHinge), (dxJoint::init_fn*)hingeInit, (dxJoint::getInfo1_fn*)hingeGetInfo1, (dxJoint::getInfo2_fn*)hingeGetInfo2, dJointTypeHinge
#ifdef DE_PADF_INTEGRATION
    ,
    (dxJoint::addBodiesForces_fn*)emptyAddForces
#endif
...
dxJoint::Vtable __dslider_vtable = {sizeof(dxJointSlider), (dxJoint::init_fn*)sliderInit, (dxJoint::getInfo1_fn*)sliderGetInfo1, (dxJoint::getInfo2_fn*)sliderGetInfo2, dJointTypeSlider
#ifdef DE_PADF_INTEGRATION
    ,
    (dxJoint::addBodiesForces_fn*)emptyAddForces
#endif
...
dxJoint::Vtable __dcontact_vtable = {sizeof(dxJointContact), (dxJoint::init_fn*)contactInit, (dxJoint::getInfo1_fn*)contactGetInfo1, (dxJoint::getInfo2_fn*)contactGetInfo2, dJointTypeContact
#ifdef DE_PADF_INTEGRATION
    ,
...
dxJoint::Vtable __dcontact_special_vtable = {sizeof(dxJointContact), (dxJoint::init_fn*)contactInit, (dxJoint::getInfo1_fn*)contactGetInfo1, (dxJoint::getInfo2_fn*)contactSpecialGetInfo2, dJointTypeContact
#ifdef DE_PADF_INTEGRATION
    ,
    (dxJoint::addBodiesForces_fn*)contactAddForces
#endif
...
static void makeHinge2V1andV2(dxJointHinge2* joint)
{
    if (joint->node[0].body)
    {
        ...
        if ((ax1[0] == 0 && ax1[1] == 0 && ax1[2] == 0) || (ax2[0] == 0 && ax2[1] == 0 && ax2[2] == 0) || (ax1[0] == ax2[0] && ax1[1] == ax2[1] && ax1[2] == ax2[2]))
            return;
...
dxJoint::Vtable __dhinge2_vtable = {sizeof(dxJointHinge2), (dxJoint::init_fn*)hinge2Init, (dxJoint::getInfo1_fn*)hinge2GetInfo1, (dxJoint::getInfo2_fn*)hinge2GetInfo2, dJointTypeHinge2
#ifdef DE_PADF_INTEGRATION
    ,
    (dxJoint::addBodiesForces_fn*)emptyAddForces
#endif
...
dxJoint::Vtable __duniversal_vtable = {sizeof(dxJointUniversal), (dxJoint::init_fn*)universalInit, (dxJoint::getInfo1_fn*)universalGetInfo1, (dxJoint::getInfo2_fn*)universalGetInfo2, dJointTypeUniversal
#ifdef DE_PADF_INTEGRATION
    ,
    (dxJoint::addBodiesForces_fn*)emptyAddForces
#endif
...
dxJoint::Vtable __damotor_vtable = {sizeof(dxJointAMotor), (dxJoint::init_fn*)amotorInit, (dxJoint::getInfo1_fn*)amotorGetInfo1, (dxJoint::getInfo2_fn*)amotorGetInfo2, dJointTypeAMotor
#ifdef DE_PADF_INTEGRATION
    ,
    (dxJoint::addBodiesForces_fn*)emptyAddForces
#endif
...
dxJoint::Vtable __dfixed_vtable = {sizeof(dxJointFixed), (dxJoint::init_fn*)fixedInit, (dxJoint::getInfo1_fn*)fixedGetInfo1, (dxJoint::getInfo2_fn*)fixedGetInfo2, dJointTypeFixed
#ifdef DE_PADF_INTEGRATION
    ,
    (dxJoint::addBodiesForces_fn*)emptyAddForces
#endif
...
dxJoint::Vtable __dnull_vtable = {sizeof(dxJointNull), (dxJoint::init_fn*)0, (dxJoint::getInfo1_fn*)nullGetInfo1, (dxJoint::getInfo2_fn*)nullGetInfo2, dJointTypeNull
#ifdef DE_PADF_INTEGRATION
    ,
    (dxJoint::addBodiesForces_fn*)emptyAddForces
#endif
