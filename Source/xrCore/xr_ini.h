...
public:
    ...
    {
        m_flags.set(eOverrideNames, b);
    }
    void save_at_end(BOOL b)
    {
        m_flags.set(eSaveAtEnd, b);
    }
    LPCSTR fname() const
    {
        return m_file_name;
    ...
    u8 r_u8(const shared_str& S, LPCSTR L) const
    {
        return r_u8(*S, L);
    }
    u16 r_u16(LPCSTR S, LPCSTR L) const;
    u16 r_u16(const shared_str& S, LPCSTR L) const
    {
        return r_u16(*S, L);
    }
    u32 r_u32(LPCSTR S, LPCSTR L) const;
    u32 r_u32(const shared_str& S, LPCSTR L) const
    {
        return r_u32(*S, L);
    }
    u64 r_u64(LPCSTR S, LPCSTR L) const;
    s8  r_s8(LPCSTR S, LPCSTR L) const;
    s8  r_s8(const shared_str& S, LPCSTR L) const
    {
        return r_s8(*S, L);
    }
    s16 r_s16(LPCSTR S, LPCSTR L) const;
    s16 r_s16(const shared_str& S, LPCSTR L) const
    {
        return r_s16(*S, L);
    }
    s32 r_s32(LPCSTR S, LPCSTR L) const;
    s32 r_s32(const shared_str& S, LPCSTR L) const
    {
        return r_s32(*S, L);
    }
...
extern XRCORE_API CInifile* pSettingsAuth;
