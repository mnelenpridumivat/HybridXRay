...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
static SAKERequest SAKE_CALL sakeiRunRequest(
    SAKE                sake,
    void*               input,
...
///////////////////////////////////////////////////////////////////////////////
SAKERequest SAKE_CALL
    sakeGetSpecificRecords(SAKE sake, SAKEGetSpecificRecordsInput* input, SAKERequestCallback callback, void* userData)
{
    return sakeiRunRequest(
...
gsi_bool SAKE_CALL sakeGetFileDownloadURL(SAKE sake, int fileId, gsi_char url[SAKE_MAX_URL_LENGTH])
{
    ...
    {
        rcode = _tsnprintf(
            url, SAKE_MAX_URL_LENGTH, _T("%s?gameid=%d&pid=%d"), gSakeDownloadUrlOverride, sake->mGameId,
            sake->mProfileId);
    }
    else
    {
...
gsi_bool SAKE_CALL sakeGetFileUploadURL(SAKE sake, gsi_char url[SAKE_MAX_URL_LENGTH])
{
    ...
    {
        rcode = _tsnprintf(
            url, SAKE_MAX_URL_LENGTH, _T("%s?gameid=%d&pid=%d"), gSakeUploadUrlOverride, sake->mGameId,
            sake->mProfileId);
    }
    else
    {
#ifdef GSI_UNICODE
        {
            // use capital %S to convert the gamename to a wide string
            rcode = _tsnprintf(
                url, SAKE_MAX_URL_LENGTH, _T("http://%S.sake.%S/SakeFileServer/upload.aspx?gameid=%d&pid=%d"),
