...
static void SAKE_CALL sakeiFillSoapRequestFieldValues(SAKERequest request, SAKEField* fields, int numFields)
{
    ...
    for (i = 0; i < numFields; i++)
    {
        ...
        else if (fields[i].mType == SAKEFieldType_BOOLEAN)
        {
            ...
            gsXmlWriteIntElement(
                request->mSoapRequest, GSI_SAKE_SERVICE_NAMESPACE, "value",
        ...
        else if (fields[i].mType == SAKEFieldType_BINARY_DATA)
        {
            ...
            gsXmlWriteBase64BinaryElement(
                request->mSoapRequest, GSI_SAKE_SERVICE_NAMESPACE, "value", fields[i].mValue.mBinaryData.mValue,
...
SAKEStartRequestResult SAKE_CALL sakeiStartCreateRecordRequest(SAKERequest request)
{
    static SAKEIRequestInfo info = {
        sizeof(SAKECreateRecordOutput), SAKEI_FUNC_NAME_STRINGS("CreateRecord"), sakeiCreateRecordValidateInput,
        sakeiCreateRecordFillSoapRequest, sakeiCreateRecordProcessSoapResponse};
...
{
    static SAKEIRequestInfo info = {
        0, SAKEI_FUNC_NAME_STRINGS("UpdateRecord"), sakeiUpdateRecordValidateInput, sakeiUpdateRecordFillSoapRequest,
        NULL};
...
{
    static SAKEIRequestInfo info = {
        0, SAKEI_FUNC_NAME_STRINGS("DeleteRecord"), sakeiDeleteRecordValidateInput, sakeiDeleteRecordFillSoapRequest,
        NULL};
