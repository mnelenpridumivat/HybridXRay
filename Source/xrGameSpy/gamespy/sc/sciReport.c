...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciCreateReport(
    gsi_u8      theSessionGuid[SC_SESSION_GUID_SIZE],
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SCResult SC_CALL sciReportSetPlayerAuthInfo(
    SCIReport*                theReport,
    gsi_u32                   thePlayerIndex,
...
SCResult SC_CALL sciReportBeginTeamData(SCIReport* theReport)
{
    ...
    // Must not have passed into player data state yet.
    GS_ASSERT(
        theReport->mReportState == SCIReportState_ROSTER || theReport->mReportState == SCIReportState_GLOBALDATA ||
        theReport->mReportState == SCIReportState_PLAYERDATA);
