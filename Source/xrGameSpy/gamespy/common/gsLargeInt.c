...
static gsi_bool gsiLargeIntKMult(
    ...
    l_word*       lenout,
    l_word        maxlen);
static gsi_bool gsiLargeIntMult(
    const l_word* data1,
    l_word        length1,
    const l_word* data2,
    l_word        length2,
...
static gsi_bool gsiLargeIntAdd(
    const l_word* data1,
    l_word        length1,
    const l_word* data2,
    l_word        length2,
    ...
    gsiLargeIntDiv(const l_word* src, l_word len, const gsLargeInt_t* div, gsLargeInt_t* dest, gsLargeInt_t* remainder)
{
    ...
    do
    {
        ...
        else
        {
            ...
            //	_asm {int 3}
            if (gsi_is_false(gsiLargeIntSubDivide(
                    &scopy[readIndex], (l_word)readLength, divisorData, divisorLen, (gsi_u32)divisorHighBit,
                    &quotientTemp)))
            {
                // overflow
                GSLINT_EXITTIMER(GSLintTimerDiv);
    ...
    l_word*       quotient)
{
    ...
    if (gsi_is_false(gsiLargeIntMult(
            divisor, dlen, quotientCopy.mData, quotientCopy.mLength, temp.mData, &temp.mLength,
    ...
    l_word        maxlen)
{
    ...
    else
    {
        ...
        if (temp1.mLength > halfLen || temp2.mLength > halfLen)
            gsiLargeIntMult(
                temp1.mData, temp1.mLength, temp2.mData, temp2.mLength, &temp3.mData[halfLen], &temp3.mLength,
        ...
        else
        {
            ...
            gsiLargeIntKMult(
                temp1.mData, temp2.mData, *lenout, &temp3.mData[halfLen], &temp3.mLength,
                (l_word)(GS_LARGEINT_MAX_DIGITS - halfLen));
        }
        ...
        gsiLargeIntSub(
            &dest[length], length, &temp3.mData[halfLen], (l_word)(temp3.mLength - halfLen), &temp3.mData[halfLen],
            &temp3.mLength);
        temp3.mLength = (l_word)(temp3.mLength + halfLen);
        gsiLargeIntSub(
            dest, length, &temp3.mData[halfLen], (l_word)(temp3.mLength - halfLen), &temp3.mData[halfLen],
            &temp3.mLength);
        temp3.mLength = (l_word)(temp3.mLength + halfLen);
