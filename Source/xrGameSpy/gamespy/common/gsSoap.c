...
GSSoapTask* gsiExecuteSoapCustom(
    const char*        theURL,
    const char*        theService,
    GSXmlStreamWriter  theRequestSoap,
    GSSoapCallbackFunc theCallbackFunc,
...
static void gsiSoapTaskExecute(void* theTask)
{
    ...
    aSoapTask->mRequestId = ghttpGetExA(
        aSoapTask->mURL, aSoapTask->mService, NULL, 0, aSoapTask->mPostData, GHTTPFalse, GHTTPFalse, NULL,
