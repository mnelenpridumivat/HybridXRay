...
public:
    ...
    bool         get_hint_enable()
    {
        return m_hint_enable;
    }
    LPCSTR           GetHint();
    void             SetHint(const shared_str& hint);
    CComplexMapSpot* complex_spot()
    {
        return m_complex_spot;
    }
    const CMapSpot* LevelMapSpot()
    {
        return m_level_spot;
    }
    const CMiniMapSpot* MiniMapSpot()
    {
        return m_minimap_spot;
    }
    ...
    IC void EnablePointer()
    {
        m_flags.set(ePointerEnabled, TRUE);
    };
    IC void DisablePointer()
    {
        m_flags.set(ePointerEnabled, FALSE);
    };

    IC bool Collidable() const
    {
        return !!m_flags.test(eCollidable);
    }
    IC bool SpotEnabled()
    {
    ...
    IC const shared_str& GetLevelName()
    {
