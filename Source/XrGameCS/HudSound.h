...
struct HUD_SOUND_ITEM
{
    ...
    static void LoadSound(LPCSTR section, LPCSTR line, ref_sound& hud_snd, int type = sg_SourceType, float* volume = NULL, float* delay = NULL);
    ...
    static void PlaySound(HUD_SOUND_ITEM& snd, const Fvector& position, const CObject* parent, bool hud_mode, bool looped = false, u8 index = u8(-1));
...
public:
    ...
    void LoadSound(LPCSTR section, LPCSTR line, LPCSTR alias, int type = sg_SourceType);
