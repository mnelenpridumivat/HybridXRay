...
CBaseMonster::SDebugInfo CBaseMonster::show_debug_info()
{
    ...
    if (SoundMemory.IsRememberSound())
    {
        ...
        switch (sound_elem.type)
        {
            case WEAPON_SHOOTING:
                strcpy_s(s_type, "WEAPON_SHOOTING");
                break;
            case MONSTER_ATTACKING:
                strcpy_s(s_type, "MONSTER_ATTACKING");
                break;
            case WEAPON_BULLET_RICOCHET:
                strcpy_s(s_type, "WEAPON_BULLET_RICOCHET");
                break;
            case WEAPON_RECHARGING:
                strcpy_s(s_type, "WEAPON_RECHARGING");
                break;

            case WEAPON_TAKING:
                strcpy_s(s_type, "WEAPON_TAKING");
                break;
            case WEAPON_HIDING:
                strcpy_s(s_type, "WEAPON_HIDING");
                break;
            case WEAPON_CHANGING:
                strcpy_s(s_type, "WEAPON_CHANGING");
                break;
            case WEAPON_EMPTY_CLICKING:
                strcpy_s(s_type, "WEAPON_EMPTY_CLICKING");
                break;

            case MONSTER_DYING:
                strcpy_s(s_type, "MONSTER_DYING");
                break;
            case MONSTER_INJURING:
                strcpy_s(s_type, "MONSTER_INJURING");
                break;
            case MONSTER_WALKING:
                strcpy_s(s_type, "MONSTER_WALKING");
                break;
            case MONSTER_JUMPING:
                strcpy_s(s_type, "MONSTER_JUMPING");
                break;
            case MONSTER_FALLING:
                strcpy_s(s_type, "MONSTER_FALLING");
                break;
            case MONSTER_TALKING:
                strcpy_s(s_type, "MONSTER_TALKING");
                break;

            case DOOR_OPENING:
                strcpy_s(s_type, "DOOR_OPENING");
                break;
            case DOOR_CLOSING:
                strcpy_s(s_type, "DOOR_CLOSING");
                break;
            case OBJECT_BREAKING:
                strcpy_s(s_type, "OBJECT_BREAKING");
                break;
            case OBJECT_FALLING:
                strcpy_s(s_type, "OBJECT_FALLING");
                break;
            case NONE_DANGEROUS_SOUND:
                strcpy_s(s_type, "NONE_DANGEROUS_SOUND");
                break;
        }
    ...
    sprintf_s(text, "MinDist[%.3f] MaxDist[%.3f] As_Step[%.3f] As_MinDist[%.3f]", MeleeChecker.get_min_distance(), MeleeChecker.get_max_distance(), MeleeChecker.dbg_as_step(), MeleeChecker.dbg_as_min_dist());
    DBG().text(this).add_item(text, x, y += delta_y, color);
