...
public:
    struct CSavedSound
    {
        ...
        IC                 CSavedSound(CScriptGameObject* lua_game_object, int sound_type, const Fvector& position, float sound_power): m_lua_game_object(lua_game_object), m_sound_type(sound_type), m_position(position), m_sound_power(sound_power) {}
    };
