...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "resyncronize client");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "clear client net statistic");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "clear server net statistic");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Kick Player by name");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, make_string("Make screenshot. Format: \"make_screenshot <player session id | \'%s\'> <ban_time_in_sec>\". To receive list of players ids see sv_listplayers", LAST_PRINTED_PLAYER_STR).c_str());
    }
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, make_string("Make config dump. Format: \"make_config_dump <player session id | \'%s\'> <ban_time_in_sec>\". To receive list of players ids see sv_listplayers", LAST_PRINTED_PLAYER_STR).c_str());
    }
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Set demo play speed (0.0, 8.0]");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Make screenshot of each player in the game. Format: \"screenshot_all");
    }
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Make config dump of each player in the game. Format: \"config_dump_all");
    }
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, make_string("Ban player. Format: \"sv_banplayer <player session id | \'%s\'> <ban_time_in_sec>\". To receive list of players ids see sv_listplayers", LAST_PRINTED_PLAYER_STR).c_str());
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Ban player by hex digest (CAREFULLY: low level command). Format: \"sv_banplayer_by_digest <hex digest> <ban_time_in_sec>\". To get player hex digest you can enter: sv_listplayers_banned");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, make_string("Unban player. Format: \"sv_unbanplayer <banned player index | \'%s\'>. To receive list of banned players see sv_listplayers_banned", LAST_PRINTED_PLAYER_BANNED_STR).c_str());
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Ban Player by IP. Format: \"sb_banplayer_ip <ip address>\"");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "UnBan Player by IP. Format: \"sv_unbanplayer_ip <ip address>\"");
    }
};
...
public:
    ...
    virtual void Execute(LPCSTR args)
    {
        ...
        struct PlayersEnumerator
        {
            ...
            void operator()(IClient* client)
            {
                ...
                sprintf_s(tmp_string, "- (player session id : %u), (name : %s), (ip: %s), (ping: %u);", client->ID.value(), l_pC->ps->getName(), Address.to_string().c_str(), l_pC->ps->ping);
                if (filter_string)
                {
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "List Players. Format: \"sv_listplayers [ filter string ]\"");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "List of Banned Players. Format: \"sv_listplayers_banned [ filter string ]\"");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Changing level, version and game type. Arguments: <level name> <level version> <game type>");
    }
};
...
public:
    ...
    virtual void Execute(LPCSTR args)
    {
        ...
        string1024 argsNew;
        sprintf_s(argsNew, "%s %s %s", Level().name().c_str(), Level().version().c_str(), args);
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Changing Game Type. Arguments: <level name> <level version>");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "List maps in map rotation list");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Switch to Next Map in map rotation list");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Switch to Previous Map in map rotation list");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Activating pointed Anomaly set");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Stops Current Voting");
    };
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "saving statistic data");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Set Start Team Money");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "swap teams for artefacthunt game");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "Shows current server settings");
    }
};
...
public:
    ...
    virtual void Info(TInfo& I)
    {
        strcpy_s(I, "valid arguments is [info info_full on off]");
    }
};
