...
bool CUIXmlInit::InitMultiTexture(CUIXml& xml_doc, LPCSTR path, int index, CUI3tButton* pWnd)
{
    ...
    if (texture.size())
    {
        ...
        {
            pWnd->m_back_frameline->CreateE()->InitTexture(*texture);
        }
        success = true;
    }
    ...
    if (texture.size())
    {
        ...
        {
            pWnd->m_back_frameline->CreateT()->InitTexture(*texture);
        }
        success = true;
    }
    ...
    if (texture.size())
    {
        ...
        {
            pWnd->m_back_frameline->CreateD()->InitTexture(*texture);
        }
        success = true;
    }
    ...
    if (texture.size())
    {
        ...
        {
            pWnd->m_back_frameline->CreateH()->InitTexture(*texture);
        }
        success = true;
    }
