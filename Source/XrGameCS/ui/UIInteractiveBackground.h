...
template<class T> void CUIInteractiveBackground<T>::InitIB(LPCSTR texture_e, Fvector2 pos, Fvector2 size)
{
    CUIWindow::SetWndPos(pos);
    CUIWindow::SetWndSize(size);
...
template<class T> void CUIInteractiveBackground<T>::InitTouchedState(LPCSTR texture_t)
{
    Fvector2 size = GetWndSize();
