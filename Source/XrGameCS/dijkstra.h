...
public:
    ...
    typedef _data_storage_constructor<_priority_queue, _vertex_manager, _data_storage_base, _vertex_allocator, _Vertex, _builder_allocator_constructor, _manager_builder_allocator_constructor> CDataStorage;
