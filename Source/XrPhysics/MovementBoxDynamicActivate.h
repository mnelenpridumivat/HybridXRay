...
public:
    ...
    virtual void
        actor_calculate(Fvector& vAccel, const Fvector& camDir, float ang_speed, float jump, float dt, bool bLight) = 0;
    virtual const Fbox* Boxes()                                                                                     = 0;
    virtual const Fbox& Box()                                                                                       = 0;
    virtual void        InterpolateBox(DWORD id, float k)                                                           = 0;
};

XRPHYSICS_API bool ActivateBoxDynamic(
    IPHMovementControl* mov_control,
