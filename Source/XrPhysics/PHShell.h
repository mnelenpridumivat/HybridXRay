...
public:
    ...
    virtual void
        Activate(const Fmatrix& transform, const Fvector& lin_vel, const Fvector& ang_vel, bool disable = false);
...
public:
    ...
    virtual bool HasTracedGeoms()
    {
        return !m_traced_geoms.empty();
    }
