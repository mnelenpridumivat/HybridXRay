...
private:
    ...
    template <class T> IC int dSortTriPrimitiveCollide(
        T              primitive,
        dxGeom*        o1,
        dxGeom*        o2,
        int            flags,
    ...
    IC dReal
        FragmentonSphereTest(const dReal* center, const dReal radius, const dReal* pt1, const dReal* pt2, dReal* norm);
