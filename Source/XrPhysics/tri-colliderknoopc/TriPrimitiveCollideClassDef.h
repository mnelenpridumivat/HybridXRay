...
#define TRI_PRIMITIVE_COLIDE_CLASS_IMPLEMENT(primitive)                                                                \
    ...
    IC int dcTriListCollider::primitive##Tri::Collide(                                                                 \
        const dReal* v0, const dReal* v1, const dReal* v2, Triangle* T, dxGeom* o1, dxGeom* o2, int flags,             \
    ...
    IC int dcTriListCollider::primitive##Tri::CollidePlain(                                                            \
        const dReal* triSideAx0, const dReal* triSideAx1, const dReal* triAx, CDB::TRI* T, dReal dist, dxGeom* o1,     \
