...
void CGamePersistent::UpdateGameType()
{
    ...
    if (!xr_strcmp(m_game_params.m_game_type, "single"))
        m_game_params.m_e_game_type_for_soc = GAME_SINGLE;
    else if (!xr_strcmp(m_game_params.m_game_type, "deathmatch"))
        m_game_params.m_e_game_type_for_soc = GAME_DEATHMATCH;
    ...
    if (m_game_params.m_e_game_type_for_soc == GAME_DEATHMATCH || m_game_params.m_e_game_type_for_soc == GAME_TEAMDEATHMATCH || m_game_params.m_e_game_type_for_soc == GAME_ARTEFACTHUNT)
