...
IC void CAI_ObjectLocation::game_vertex(const IGameGraph::CVertex* game_vertex)
{
...
IC void CAI_ObjectLocation::level_vertex(const ILevelGraph::CVertex* level_vertex)
{
...
IC const ILevelGraph::CVertex* CAI_ObjectLocation::level_vertex() const
{
