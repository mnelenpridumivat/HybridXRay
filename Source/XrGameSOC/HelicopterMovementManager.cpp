...
void SHeliMovementState::SetPointFlags(u32 idx, u32 new_flags)
{
    ...
    CPatrolPoint* pt_new  = xr_new<CPatrolPoint>((ILevelGraph*)0, (IGameLevelCrossTable*)0, (IGameGraph*)0, currPatrolPath, pt_curr->position(), u32(-1), new_flags, pt_curr->name());
