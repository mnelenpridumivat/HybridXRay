...
private:
    template<typename _evaluator_type, typename _restrictor_type> IC bool inertia(float radius, _evaluator_type& evaluator, const _restrictor_type& restrictor) const;
