...
void CExplosive::Explode()
{
    ...
    for (int i = 0; i < m_iFragsNum; ++i)
    {
        ...
        Level().BulletManager().AddBullet(pos, frag_dir, m_fFragmentSpeed, m_fFragHit, m_fFragHitImpulse, Initiator(), cast_game_object()->ID(), m_eHitTypeFrag, m_fFragsRadius, cartridge, SendHits);
    }
